...
!!                   d2vxci(:,3)=3rd order derivative of XC energy with respect to rhouprhodnrhoup
...
!scalars
 ...
 real(dp) :: d3ecrs_drupdrdn2,d3ecrs_drdn3,d3ecrs_dzeta3,d3ecrs_drho3
 ...
 real(dp) :: fp_zeta,fpp_zeta,fppp_zeta,fx,gamphi3inv,gcrs,grr,grrho2,hh,kappa
...
!a simple factor which will be replaced by spin dependent coefficients
!for third order derivatives of the xc energy
 blabla=1.0_dp 
...
!     correlation energy with respect to spin densities
      d3ecrs_drho3=(-1._dp/27._dp)*(rs*(rhotot_inv**2))*(-2._dp*decrs_drs+   &
&      rs*d3ecrs_drs3)
...
&      8._dp*zeta**3*fpp_zeta+4._dp*zeta*fpp_zeta+zeta**4*fppp_zeta)*gcrs-   &
&      fppp_zeta*macrs*fsec_inv

!     third order derivatives
      d3ecrs_drup3=d3ecrs_drho3+d2ecrs_drsdzeta*((2._dp/3._dp)*(blabla)+  &
&      d2ecrs_dzeta2*(blabla)+(1._dp/9._dp)*((rs**2)*rhotot_inv)*(blabla)*  &
&      d3ecrs_drs2dzeta+(blabla)*(-third)*rs*d3ecrs_dzeta2drs+  &
&      (blabla)*d3ecrs_dzeta3)
      d3ecrs_drup2drdn=d3ecrs_drho3+d2ecrs_drsdzeta*((2._dp/3._dp)*(blabla)+  &
&      d2ecrs_dzeta2*(blabla)+(1._dp/9._dp)*((rs**2)*rhotot_inv)*(blabla)*  &
&      d3ecrs_drs2dzeta+(blabla)*(-third)*rs*d3ecrs_dzeta2drs+  &
&      (blabla)*d3ecrs_dzeta3)
      d3ecrs_drupdrdn2=d3ecrs_drho3+d2ecrs_drsdzeta*((2._dp/3._dp)*(blabla)+  &
&      d2ecrs_dzeta2*(blabla)+(1._dp/9._dp)*((rs**2)*rhotot_inv)*(blabla)*  &
&      d3ecrs_drs2dzeta+(blabla)*(-third)*rs*d3ecrs_dzeta2drs+  &
&      (blabla)*d3ecrs_dzeta3)
      d3ecrs_drdn3=d3ecrs_drho3+d2ecrs_drsdzeta*((2._dp/3._dp)*(blabla)+  &
&      d2ecrs_dzeta2*(blabla)+(1._dp/9._dp)*((rs**2)*rhotot_inv)*(blabla)*  &
&      d3ecrs_drs2dzeta+(blabla)*(-third)*rs*d3ecrs_dzeta2drs+  &
&      (blabla)*d3ecrs_dzeta3)
