...
!!
!! PARENTS
!!      abinit,acfd_dyson,acfd_intexact,atm2fft,bestwfs,calc_rpa_functional
!!      calcdensph,cchi0,cgwf,cgwf3,csigme,dielmt,dielmt2,dieltcel,dotprod_g
!!      dotprod_v,dotprod_vn,dotprodm_v,dotprodm_vn,driver,dyfnl3,dyfro3
!!      eltfrhar3,eltfrkin3,eltfrloc3,eltfrnl3,eltfrxc3,energy,entropyrec
!!      etotfor,fermisolverec,filnam_comm,filterpot,forces,forstrnps,fourdp
!!      fourwf,gran_potrec,fxphas,getgh1c,getghc,getgsc,getngrec
!!      green_kernel,gstate,hartre,hartre1,initylmg,inkpts,invars2,inwffil
!!      inwffil3,kpgio,kpgsph,ladielmt,lavnl,leave_test,lobpcgIIwf,lobpcgccIIwf
!!      lobpcgccwf,lobpcgwf,loop3dte,loper3,make_epsm1_driver,matrixelmt_g
...
!!      newvtr3,nhatgrid,nonlinear,nonlop,nstdy3,nstwf3,odamix,opernla_ylm
!!      optics_paw,optics_paw_core,outkss,outscfcv,outwf,pareigocc
!!      partial_dos_fractions_paw,pawdenpot,pawdij,pawinit,pawmkrhoij,pawpolev
!!      pawxc,pawxc3,pawxcm,pawxcm3,prctfvw1,prctfvw2,precon,precon2
!!      prep_fourwf,prep_getghc,prep_nonlop,projbd,pspheads_comm,pspini
!!      pw_orthon,recursion,redgr,respfn,rhofermi3,rhohxc,rhotov,rhotov3,rwwf
!!      scfcv,scfcv3,screening,setsym,setvtr,sigma,sqnorm_g,sqnorm_v,sqnormm_v
!!      status,stress,strhar,subdiago,suscep,suscep_dyn,suscep_kxc_dyn
!!      suscep_stat,susk,susk_dyn,susk_dyn_pgg,susk_kxc_dyn,suskmm,suskmm_dyn
!!      suskmm_kxc_dyn,symrhg,symsgcube,tddft,timana,vtorho,vtorho3,vtorhorec
