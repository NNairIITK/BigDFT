...
!!
!! COPYRIGHT
!! Copyright (C) 2009-2014 ABINIT group (MG, MB, XG, YP, MT)
...
!Arguments ------------------------------------
!scalars
 integer,intent(in) :: mpi_fh,sc_mode
...
!Arguments ------------------------------------
!scalars
 integer,intent(in) :: mpi_fh,nfrec,sc_mode
...
!Arguments ------------------------------------
!scalars
 integer,intent(in) :: mpi_fh,sc_mode,ncount
 integer(XMPI_OFFSET_KIND),intent(inout) :: offset
 integer(XMPI_OFFSET_KIND),intent(out) :: fmarker
 integer,intent(out) :: mpierr
 logical,optional,intent(in) :: advance
