...
module xc_f90_lib_m
  ...
  interface
    ...
    integer function xc_f90_info_provides(info)
      use xc_f90_types_m
      type(xc_f90_pointer_t), intent(in) :: info
    end function xc_f90_info_provides
  ...
  !----------------------------------------------------------------
  interface
    subroutine xc_f90_mgga(p, rho, sigma, lrho, tau, zk, vrho, vsigma, vlrho, vtau, &
    ...
    subroutine xc_f90_mgga_exc(p, rho, sigma, lrho, tau, zk)
      use xc_f90_types_m
      type(xc_f90_pointer_t), intent(in) :: p
      real(xc_f90_kind), intent(in) :: rho
      real(xc_f90_kind), intent(in) :: sigma
    ...
    subroutine xc_f90_mgga_exc_vxc(p, rho, sigma, lrho, tau, zk, vrho, vsigma, vlrho, vtau)
      use xc_f90_types_m
      type(xc_f90_pointer_t), intent(in) :: p
      real(xc_f90_kind), intent(in) :: rho
      real(xc_f90_kind), intent(in) :: sigma
    ...
    subroutine xc_f90_mgga_vxc(p, rho, sigma, lrho, tau, vrho, vsigma, vlrho, vtau)
      use xc_f90_types_m
      type(xc_f90_pointer_t), intent(in) :: p
      real(xc_f90_kind), intent(in) :: rho
      real(xc_f90_kind), intent(in) :: sigma
    ...
    subroutine xc_f90_mgga_fxc(p, rho, sigma, lrho, tau, &
      v2rho2, v2rhosigma, v2sigma2, v2rhotau, v2tausigma, v2tau2)
