...
\item \texttt{freq\_order} which determines the order of the finite difference scheme (2 or 3);
\item \texttt{freq_method} which determines the method (only 1 at the present stage).
\end{itemize}
