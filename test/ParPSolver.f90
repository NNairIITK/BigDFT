...
program PSolver
  ...
  real(kind=8), dimension(:,:,:), allocatable :: density, rhopot, kernelLOC
  ...
  if (iproc .eq. 0) print *,"PSolver: ",n01,n02,n03
  ...
  allocate(kernelLOC(nd1,nd2,nd3/nproc))
  call ParBuild_Kernel(n01,n02,n03,n1,n2,n3,nd1,nd2,nd3,hgrid,8,iproc,nproc,kernelLOC)
  call ParPSolver_Kernel(n01,n02,n03,nd1,nd2,nd3,hgrid,kernelLOC,.false.,pot_ion,rhopot,ehartree,eexcu,vexcu,iproc,nproc)
  deallocate(kernelLOC)
