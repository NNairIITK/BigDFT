...
!deallocate(psigdev,allwprojdev)
...
!istat = cudaStreamSynchronize(stream2)
 ...
 call convol_part2_kernel<<<dimGrid,dimBlock,0,stream1>>>(psigdev,ydev, ekinvecdev, filterdev,ibyz_cdev,n1,n2,n3,lowfil,lupfil)
...
!cublas was already initialized in createAtomicOrbitals
!call cublas_init
