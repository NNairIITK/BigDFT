...
!     give hij and projectors in nonorthogonal and othonormal space!
...
!               write(6,*)'HHij=',hh11,hh12,hh22
               endif
!               write(6,*)'hsep1',hsep(1,ll+1,ispin), &
!     :              hsep(2,ll+1,ispin),hsep(3,ll+1,ispin)
