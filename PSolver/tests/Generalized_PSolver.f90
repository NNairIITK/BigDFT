...
program GPS_3D
   ...
   integer, parameter :: SetEps = 3 ! To set 1 for Vacuum, 2 for error function in y direction, 3 for gaussian, 4 for electron dependence.
   ...
   integer, parameter :: Setrho = 2 ! To set 1 for gaussian rho, 2 for gaussian potential. Beaware to use 2 or 3 when SetEps is setted to 3!!! 
   character(len=2), parameter :: geocode = 'F'
   character(len=2), parameter :: datacode = 'G'
   integer, parameter :: nord = 16 ! Order of accuracy for derivatives into ApplyLaplace subroutine = Total number of points at left and right of the x0 where we want to calculate the derivative.
   ...
   real(kind=8), dimension(n01,n02,n03,nspden) :: density,rhopot,rvApp
   real(kind=8), pointer :: kernel(:)
   type(coulomb_operator) :: pkernel
!   type(mpi_environment), intent(in), optional :: mpi_env
   real(kind=8), dimension(n01,n02,n03) :: eps,potential,pot_ion
...
!       write(jj,'(1x,I4,2(1x,e22.15))') i1,r(i1,n02/2,i3,1),r(i1,1,i3,1)
      ...
      write(39,'(4(1x,I4),4(1x,e22.15))')i,i1_max,i2_max,i3_max,max_val,r(n01/2,n02/2,n03/2,1),r(2,n02/2,n03/2,1),r(10,n02/2,n03/2,1)
...
subroutine writeroutinePot(n01,n02,n03,nspden,ri,i,potential)
  ...
  real(kind=8) :: max_val,fact
      ...
      write(38,'(4(1x,I4),4(1x,e22.15))')i,i1_max,i2_max,i3_max,max_val,re(n01/2,n02/2,n03/2,1),re(2,n02/2,n03/2,1),re(10,n02/2,n03/2,1)
      write(*,'(4(1x,I4),4(1x,e22.15))')i,i1_max,i2_max,i3_max,max_val,re(n01/2,n02/2,n03/2,1),re(2,n02/2,n03/2,1),re(10,n02/2,n03/2,1)
...
! Set initial potential as double gaussian and density as the correct Generalized Laplace operator. It works with a gaussian epsilon.
