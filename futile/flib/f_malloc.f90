...
module module_f_malloc
  ...
  type, public :: malloc_information_all
     ...
     logical :: shared                       !< share the allocation using simgrid
...
contains
  ...
  !> For rank-1 arrays
  pure function f_malloci_simple(size,id,routine_id,profile,shared) result(m)
    implicit none
    type(malloc_information_all) :: m
    include 'f_malloci-simple-inc.f90'
  end function f_malloci_simple
  pure function f_mallocli_simple(size,id,routine_id,profile,shared) result(m)
    implicit none
    type(malloc_information_all) :: m
    include 'f_mallocli-simple-inc.f90'
  end function f_mallocli_simple
  !> For rank-1 arrays
  pure function f_malloci0_simple(size,id,routine_id,profile,shared) result(m)
    implicit none
    type(malloc_information_all) :: m
    include 'f_malloci-simple-inc.f90'
    m%put_to_zero=.true.
  end function f_malloci0_simple
  pure function f_mallocli0_simple(size,id,routine_id,profile,shared) result(m)
    implicit none
    type(malloc_information_all) :: m
    include 'f_mallocli-simple-inc.f90'
    m%put_to_zero=.true.
  ...
  !> For rank-1 arrays
  pure function f_malloci_ptr_simple(size,id,routine_id,profile,shared) result(m)
    implicit none
    type(malloc_information_ptr) :: m
    include 'f_malloci-simple-inc.f90'
  end function f_malloci_ptr_simple
  pure function f_mallocli_ptr_simple(size,id,routine_id,profile,shared) result(m)
    implicit none
    type(malloc_information_ptr) :: m
    include 'f_mallocli-simple-inc.f90'
  end function f_mallocli_ptr_simple
  !> For rank-1 arrays
  pure function f_malloci0_ptr_simple(size,id,routine_id,profile,shared) result(m)
    implicit none
    type(malloc_information_ptr) :: m
    include 'f_malloci-simple-inc.f90'
    m%put_to_zero=.true.
  end function f_malloci0_ptr_simple
  pure function f_mallocli0_ptr_simple(size,id,routine_id,profile,shared) result(m)
    implicit none
    type(malloc_information_ptr) :: m
    include 'f_mallocli-simple-inc.f90'
    m%put_to_zero=.true.
  ...
  !> For rank-1 arrays
  pure function f_malloci_str_simple(length,size,id,routine_id,profile,shared) result(m)
    implicit none
  ...
  pure function f_mallocli_str_simple(length,size,id,routine_id,profile,shared) result(m)
    implicit none
    type(malloc_information_str_all) :: m
    integer, intent(in) :: length
    include 'f_mallocli-simple-inc.f90'
  ...
  !> For rank-1 arrays
  pure function f_malloci0_str_simple(length,size,id,routine_id,profile,shared) result(m)
    implicit none
    type(malloc_information_str_all) :: m
    integer, intent(in) :: length
    include 'f_malloci-simple-inc.f90'
  ...
  pure function f_mallocli0_str_simple(length,size,id,routine_id,profile,shared) result(m)
    implicit none
    type(malloc_information_str_all) :: m
    integer, intent(in) :: length
    include 'f_mallocli-simple-inc.f90'
  ...
  !> For rank-1 arrays
  pure function f_malloci_str_ptr_simple(length,size,id,routine_id,profile,shared) result(m)
    implicit none
  ...
  pure function f_mallocli_str_ptr_simple(length,size,id,routine_id,profile,shared) result(m)
    implicit none
    type(malloc_information_str_ptr) :: m
    integer, intent(in) :: length
    include 'f_mallocli-simple-inc.f90'
  ...
  !> For rank-1 arrays
  pure function f_malloci0_str_ptr_simple(length,size,id,routine_id,profile,shared) result(m)
    implicit none
    type(malloc_information_str_ptr) :: m
    integer, intent(in) :: length
    include 'f_malloci-simple-inc.f90'
  ...
  pure function f_mallocli0_str_ptr_simple(length,size,id,routine_id,profile,shared) result(m)
    implicit none
    type(malloc_information_str_ptr) :: m
    integer, intent(in) :: length
    include 'f_mallocli-simple-inc.f90'
  ...
  pure function f_malloc_bound(bounds,id,routine_id,profile,shared) result(m)
    implicit none
    type(malloc_information_all) :: m
    include 'f_malloc-bound-inc.f90'
  end function f_malloc_bound
  !>for rank-1 arrays, with boundaries
  pure function f_malloc0_bound(bounds,id,routine_id,profile,shared) result(m)
    implicit none
    type(malloc_information_all) :: m
    include 'f_malloc-bound-inc.f90'
    m%put_to_zero=.true.
  ...
  !> For rank-1 arrays
  pure function f_malloc_ptr_bound(bounds,id,routine_id,profile,shared) result(m)
    implicit none
    type(malloc_information_ptr) :: m
    include 'f_malloc-bound-inc.f90'
  end function f_malloc_ptr_bound
  !> For rank-1 arrays
  pure function f_malloc0_ptr_bound(bounds,id,routine_id,profile,shared) result(m)
    implicit none
    type(malloc_information_ptr) :: m
    include 'f_malloc-bound-inc.f90'
    m%put_to_zero=.true.
  ...
  !> For rank-1 arrays, with bounds
  pure function f_malloc_str_bound(length,bounds,id,routine_id,profile,shared) result(m)
    implicit none
    type(malloc_information_str_all) :: m
    integer, intent(in) :: length
    include 'f_malloc-bound-inc.f90'
  ...
  !!pure function f_malloc_listr_bound(length,bounds,id,routine_id,profile,shared) result(m)
  !!  implicit none
  !!  type(malloc_information_str_all) :: m
  ...
  !>for rank-1 arrays, with boundaries
  pure function f_malloc0_str_bound(length,bounds,id,routine_id,profile,shared) result(m)
    implicit none
    type(malloc_information_str_all) :: m
    integer, intent(in) :: length
    include 'f_malloc-bound-inc.f90'
  ...
  !!pure function f_malloc0_listr_bound(length,bounds,id,routine_id,profile,shared) result(m)
  !!  implicit none
  !!  type(malloc_information_str_all) :: m
  !!  integer(kind=4), intent(in) :: length
  !!  include 'f_malloc-bound-inc.f90'
  ...
  !> For rank-1 arrays
  pure function f_malloc_str_ptr_bound(length,bounds,id,routine_id,profile,shared) result(m)
    implicit none
    type(malloc_information_str_ptr) :: m
    integer, intent(in) :: length
    include 'f_malloc-bound-inc.f90'
  ...
  !> For rank-1 arrays
  pure function f_malloc0_str_ptr_bound(length,bounds,id,routine_id,profile,shared) result(m)
    implicit none
    type(malloc_information_str_ptr) :: m
    integer, intent(in) :: length
    include 'f_malloc-bound-inc.f90'
  ...
  pure function f_malloc0_listr_ptr_bound(length,bounds,id,routine_id,profile,shared) result(m)
    implicit none
    type(malloc_information_str_ptr) :: m
    integer, intent(in) :: length
    include 'f_malloc-bound-inc.f90'
  ...
  pure function f_malloc_bounds(bounds,id,routine_id,profile,shared) result(m)
    implicit none
    type(malloc_information_all) :: m
    include 'f_malloc-bounds-inc.f90'
  end function f_malloc_bounds
  pure function f_malloc0_bounds(bounds,id,routine_id,profile,shared) result(m)
    implicit none
    type(malloc_information_all) :: m
    include 'f_malloc-bounds-inc.f90'
    m%put_to_zero=.true.
  ...
  !> Define the allocation information for  arrays of different rank
  pure function f_malloc_ptr_bounds(bounds,id,routine_id,profile,shared) result(m)
    implicit none
    type(malloc_information_ptr) :: m
    include 'f_malloc-bounds-inc.f90'
  end function f_malloc_ptr_bounds
  !> Define the allocation information for  arrays of different rank
  pure function f_malloc0_ptr_bounds(bounds,id,routine_id,profile,shared) result(m)
    implicit none
    type(malloc_information_ptr) :: m
    include 'f_malloc-bounds-inc.f90'
    m%put_to_zero=.true.
  ...
  !> Define the allocation information for  arrays of different rank
  pure function f_malloc_str_bounds(length,bounds,id,routine_id,profile,shared) result(m)
    implicit none
    type(malloc_information_str_all) :: m
    integer, intent(in) :: length
    include 'f_malloc-bounds-inc.f90'
  ...
  !!pure function f_malloc_listr_bounds(length,bounds,id,routine_id,profile,shared) result(m)
  !!  implicit none
  !!  type(malloc_information_str_all) :: m
  !!  integer(kind=4), intent(in) :: length
  !!  include 'f_malloc-bounds-inc.f90'
  ...
  pure function f_malloc0_str_bounds(length,bounds,id,routine_id,profile,shared) result(m)
    implicit none
    type(malloc_information_str_all) :: m
    integer, intent(in) :: length
    include 'f_malloc-bounds-inc.f90'
  ...
  !!pure function f_malloc0_listr_bounds(length,bounds,id,routine_id,profile,shared) result(m)
  !!  implicit none
  !!  type(malloc_information_str_all) :: m
  !!  integer(kind=4), intent(in) :: length
  !!  include 'f_malloc-bounds-inc.f90'
  ...
  !> Define the allocation information for  arrays of different rank
  pure function f_malloc_str_ptr_bounds(length,bounds,id,routine_id,profile,shared) result(m)
    implicit none
    type(malloc_information_str_ptr) :: m
    integer, intent(in) :: length
    include 'f_malloc-bounds-inc.f90'
  ...
  !> Define the allocation information for  arrays of different rank
  pure function f_malloc0_str_ptr_bounds(length,bounds,id,routine_id,profile,shared) result(m)
    implicit none
    type(malloc_information_str_ptr) :: m
    integer, intent(in) :: length
    include 'f_malloc-bounds-inc.f90'
  ...
  !> Define the allocation information for arrays of different rank
  function f_malloc(sizes,id,routine_id,lbounds,ubounds,profile,shared,src,src_ptr) result(m)
    implicit none
  ...
  !> define the allocation information for  arrays of different rank
  function f_malloc0(sizes,id,routine_id,lbounds,ubounds,profile,shared) result(m)
    implicit none
    type(malloc_information_all) :: m
    include 'f_malloc-total-inc.f90'
    m%put_to_zero=.true.
  end function f_malloc0
  !!function f_mallocli0(sizes,id,routine_id,lbounds,ubounds,profile,shared) result(m)
  !!  implicit none
  !!  type(malloc_information_all) :: m
  ...
  !> Define the allocation information for  arrays of different rank
  function f_malloc_ptr(sizes,id,routine_id,lbounds,ubounds,profile,shared,src,src_ptr) result(m)
    implicit none
  ...
  !> Define the allocation information for  arrays of different rank
  function f_malloc0_ptr(sizes,id,routine_id,lbounds,ubounds,profile,shared) result(m)
    implicit none
    type(malloc_information_ptr) :: m
    include 'f_malloc-total-inc.f90'
    m%put_to_zero=.true.
  end function f_malloc0_ptr
  !!function f_mallocli0_ptr(sizes,id,routine_id,lbounds,ubounds,profile,shared) result(m)
  !!  implicit none
  !!  type(malloc_information_ptr) :: m
  !!  include 'f_mallocli-total-inc.f90'
  !!  m%put_to_zero=.true.
  ...
  !> Define the allocation information for  arrays of different rank
  function f_malloci_str(length,sizes,id,routine_id,lbounds,ubounds,profile,shared) result(m)
    implicit none
    type(malloc_information_str_all) :: m
    integer, intent(in) :: length
    include 'f_malloc-total-inc.f90'
  ...
  !> define the allocation information for  arrays of different rank
  function f_malloci0_str(length,sizes,id,routine_id,lbounds,ubounds,profile,shared) result(m)
    implicit none
    type(malloc_information_str_all) :: m
    integer, intent(in) :: length
    include 'f_malloc-total-inc.f90'
  ...
  !> Define the allocation information for  arrays of different rank
  function f_malloci_str_ptr(length,sizes,id,routine_id,lbounds,ubounds,profile,shared) result(m)
    implicit none
    type(malloc_information_str_ptr) :: m
    integer, intent(in) :: length
    include 'f_malloc-total-inc.f90'
  ...
  !> Define the allocation information for  arrays of different rank
  function f_malloci0_str_ptr(length,sizes,id,routine_id,lbounds,ubounds,profile,shared) result(m)
    implicit none
    type(malloc_information_str_ptr) :: m
    integer, intent(in) :: length
    include 'f_malloc-total-inc.f90'
  ...
  function f_malloc_d1(src,lbounds,ubounds,id,routine_id,profile,shared) result(m)
    implicit none
  ...
  function f_malloc_d2(src,id,routine_id,lbounds,ubounds,profile,shared) result(m)
    implicit none
    double precision, dimension(:,:), intent(in) :: src
    integer, dimension(:), intent(in), optional :: lbounds,ubounds
    type(malloc_information_all) :: m
  ...
  function f_malloc_d3(src,id,routine_id,lbounds,ubounds,profile,shared) result(m)
    implicit none
    double precision, dimension(:,:,:), intent(in) :: src
    integer, dimension(:), intent(in), optional :: lbounds,ubounds
    type(malloc_information_all) :: m
  ...
  function f_malloc_d4(src,id,routine_id,lbounds,ubounds,profile,shared) result(m)
    implicit none
    double precision, dimension(:,:,:,:), intent(in) :: src
    integer, dimension(:), intent(in), optional :: lbounds,ubounds
    type(malloc_information_all) :: m
  ...
  function f_malloc_d5(src,id,routine_id,lbounds,ubounds,profile,shared) result(m)
    implicit none
    double precision, dimension(:,:,:,:,:), intent(in) :: src
    integer, dimension(:), intent(in), optional :: lbounds,ubounds
    type(malloc_information_all) :: m
  ...
  function f_malloc_r1(src,lbounds,ubounds,id,routine_id,profile,shared) result(m)
    implicit none
  ...
  function f_malloc_r2(src,id,routine_id,lbounds,ubounds,profile,shared) result(m)
    implicit none
    real, dimension(:,:), intent(in) :: src
    integer, dimension(:), intent(in), optional :: lbounds,ubounds
    type(malloc_information_all) :: m
  ...
  function f_malloc_r3(src,id,routine_id,lbounds,ubounds,profile,shared) result(m)
    implicit none
    real, dimension(:,:,:), intent(in) :: src
    integer, dimension(:), intent(in), optional :: lbounds,ubounds
    type(malloc_information_all) :: m
  ...
  function f_malloc_r4(src,id,routine_id,lbounds,ubounds,profile,shared) result(m)
    implicit none
    real, dimension(:,:,:,:), intent(in) :: src
    integer, dimension(:), intent(in), optional :: lbounds,ubounds
    type(malloc_information_all) :: m
  ...
  function f_malloc_i2(src,id,routine_id,lbounds,ubounds,profile,shared) result(m)
    implicit none
  ...
  function f_malloc_i3(src,id,routine_id,lbounds,ubounds,profile,shared) result(m)
    implicit none
    integer, dimension(:,:,:), intent(in) :: src
    integer, dimension(:), intent(in), optional :: lbounds,ubounds
    type(malloc_information_all) :: m
  ...
  function f_malloc_l3(src,id,routine_id,lbounds,ubounds,profile,shared) result(m)
    implicit none
...
!!$  function f_malloc_ptr_i2(src,id,routine_id,sizes,lbounds,ubounds,profile,shared) result(m)
!!$    implicit none
!!$    integer, dimension(:,:), intent(in) :: src
!!$    integer, dimension(:), intent(in), optional :: sizes,lbounds,ubounds
!!$    type(malloc_information_ptr) :: m
...
!!$  end function f_malloc_ptr_i2
  ...
  function f_malloc_ptr_i2_sp(src_ptr,id,routine_id,profile,shared) result(m)
    implicit none
...
!!$  function f_malloc_ptr_i3(src,id,routine_id,sizes,lbounds,ubounds,profile,shared) result(m)
!!$    implicit none
!!$    integer, dimension(:,:,:), intent(in) :: src
!!$    integer, dimension(:), intent(in), optional :: sizes,lbounds,ubounds
!!$    type(malloc_information_ptr) :: m
...
!!$  end function f_malloc_ptr_i3
  ...
  !this template is here waiting for a new unambiguous module procedure
  function f_malloc_ptr_i3_sp(src_ptr,id,routine_id,profile,shared) result(m)
    implicit none
    integer, dimension(:,:,:), pointer, intent(in) :: src_ptr
    type(malloc_information_ptr) :: m
    include 'f_malloc-base-inc.f90'
  ...
  !this template is here waiting for a new unambiguous module procedure
  function f_malloc_ptr_i4_sp(src_ptr,id,routine_id,profile,shared) result(m)
    implicit none
    integer, dimension(:,:,:,:), pointer, intent(in) :: src_ptr
    type(malloc_information_ptr) :: m
    include 'f_malloc-base-inc.f90'
  ...
  !this template is here waiting for a new unambiguous module procedure
  function f_malloc_ptr_d1_sp(src_ptr,id,routine_id,profile,shared) result(m)
    implicit none
  ...
  !this template is here waiting for a new unambiguous module procedure
  function f_malloc_ptr_d2_sp(src_ptr,id,routine_id,profile,shared) result(m)
    implicit none
    double precision, dimension(:,:), pointer, intent(in) :: src_ptr
    type(malloc_information_ptr) :: m
    include 'f_malloc-base-inc.f90'
  ...
  !this template is here waiting for a new unambiguous module procedure
  function f_malloc_ptr_d3_sp(src_ptr,id,routine_id,profile,shared) result(m)
    implicit none
    double precision, dimension(:,:,:), pointer, intent(in) :: src_ptr
    type(malloc_information_ptr) :: m
    include 'f_malloc-base-inc.f90'
  ...
  !this template is here waiting for a new unambiguous module procedure
  function f_malloc_ptr_d4_sp(src_ptr,id,routine_id,profile,shared) result(m)
    implicit none
    double precision, dimension(:,:,:,:), pointer, intent(in) :: src_ptr
    type(malloc_information_ptr) :: m
    include 'f_malloc-base-inc.f90'
  ...
  function f_malloc_ptr_d5_sp(src_ptr,id,routine_id,profile,shared) result(m)
    implicit none
    double precision, dimension(:,:,:,:,:), pointer, intent(in) :: src_ptr
    type(malloc_information_ptr) :: m
    include 'f_malloc-base-inc.f90'
  ...
  function f_malloc_buf(sizes,id,routine_id,profile,shared,src) result(m)
    implicit none
    !the integer array src is here added to avoid problems in resolving the ambiguity
    integer, dimension(:), intent(in), optional :: src
  ...
  !> Define the allocation information for  arrays of different rank
  function f_malloc0_buf(sizes,id,routine_id,profile,src,shared) result(m)
    implicit none
    !the integer array src is here added to avoid problems in resolving the ambiguity
    integer, dimension(:), intent(in), optional :: src
    include 'f_malloc-buf-base-inc.f90'
...
!!$  function f_malloc_ptr_d1(id,src,routine_id,sizes,lbounds,ubounds,profile,shared) result(m)
!!$    implicit none
...
!!$  function f_malloc_ptr_d2(id,src,routine_id,sizes,lbounds,ubounds,profile,shared) result(m)
!!$    implicit none
!!$    double precision, dimension(:,:), optional, intent(in) :: src
!!$    integer, dimension(:), intent(in), optional :: sizes,lbounds,ubounds
!!$    type(malloc_information_ptr) :: m
...
!!$
!!$  function f_malloc_ptr_d3(id,src,routine_id,sizes,lbounds,ubounds,profile,shared) result(m)
!!$    implicit none
!!$    double precision, dimension(:,:,:), optional, intent(in) :: src
!!$    integer, dimension(:), intent(in), optional :: sizes,lbounds,ubounds
!!$    type(malloc_information_ptr) :: m
...
!!$
!!$  function f_malloc_ptr_d4(id,src,routine_id,sizes,lbounds,ubounds,profile,shared) result(m)
!!$    implicit none
!!$    double precision, dimension(:,:,:,:), optional, intent(in) :: src
!!$    integer, dimension(:), intent(in), optional :: sizes,lbounds,ubounds
!!$    type(malloc_information_ptr) :: m
