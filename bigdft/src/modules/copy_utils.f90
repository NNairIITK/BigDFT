module copy_utils
  ...
  interface allocate_and_copy
    module procedure allocate_and_copy_i1, allocate_and_copy_i2, allocate_and_copy_i3, &
  ...
  contains
    ...
    subroutine allocate_and_copy_i3(array_in, array_out, id)
      ...
      character(len=*),intent(in) :: id
      ! Local variables
      integer :: iis1, iie1, iis2, iie2, iis3, iie3, ncount
      ...
      if (associated(array_in)) then
          ...
          iis2=lbound(array_in,2)
          iie2=ubound(array_in,2)
          iis3=lbound(array_in,3)
          iie3=ubound(array_in,3)
    ...
    end subroutine allocate_and_copy_d3
