...
/* localfields_get_rhov src/bindings/bindingsf.f90:1025 */
/* Fortran header:
...
/* localfields_get_v_ext src/bindings/bindingsf.f90:1036 */
/* Fortran header:
...
/* localfields_get_v_xc src/bindings/bindingsf.f90:1047 */
/* Fortran header:
...
/* orbs_get_eval src/bindings/bindingsf.f90:819 */
/* Fortran header:
...
/* orbs_get_inwhichlocreg src/bindings/bindingsf.f90:863 */
/* Fortran header:
...
/* orbs_get_kpts src/bindings/bindingsf.f90:841 */
/* Fortran header:
...
/* orbs_get_kwgts src/bindings/bindingsf.f90:852 */
/* Fortran header:
...
/* orbs_get_occup src/bindings/bindingsf.f90:830 */
/* Fortran header:
...
/* orbs_get_onwhichatom src/bindings/bindingsf.f90:873 */
/* Fortran header:
...
/* orbs_get_onwhichmpi  */
/* allocate_atoms_nat src/modules/atoms_data.f90:1348 */
/* Fortran header:
...
/* allocate_atoms_ntypes src/modules/atoms_data.f90:1366 */
/* Fortran header:
...
/* allocaterhopot src/init/denspotd.f90:457 */
/* Fortran header:
...
/* astruct_set_displacement src/modules/atoms_data.f90:1425 */
/* Fortran header:
...
/* astruct_set_from_dict_binding src/bindings/bindingsf.f90:1940 */
/* Fortran header:
...
/* astruct_set_from_file src/modules/atoms_data.f90:1241 */
/* Fortran header:
...
void FC_FUNC_(astruct_set_geometry, ASTRUCT_SET_GEOMETRY)(f90_atomic_structure *astruct, 
                                                          ...
                                                          int str_ln_2, 
                                                          int str_ln_3);
/* astruct_set_n_atoms src/modules/atoms_data.f90:1177 */
/* Fortran header:
...
void FC_FUNC_(astruct_set_n_atoms, ASTRUCT_SET_N_ATOMS)(f90_atomic_structure *astruct, 
                                                        const int *nat);
/* astruct_set_n_types src/modules/atoms_data.f90:1214 */
/* Fortran header:
...
void FC_FUNC_(astruct_set_n_types, ASTRUCT_SET_N_TYPES)(f90_atomic_structure *astruct, 
                                                        const int *ntypes);
/* astruct_set_symmetries src/modules/atoms_data.f90:1259 */
/* Fortran header:
...
/* atoms_free src/modules/atoms_data.f90:1409 */
/* Fortran header:
...
/* atoms_new src/modules/atoms_data.f90:1394 */
/* Fortran header:
...
void FC_FUNC_(atoms_write, ATOMS_WRITE)(const f90_atoms_data *atoms, 
                                        ...
                                        int str_ln_1, 
                                        int str_ln_2);
/* bigdft_exec src/bindings/bindingsf.f90:1629 */
/* Fortran header:
...
void FC_FUNC_(bigdft_exec, BIGDFT_EXEC)(f90_run_objects *runObj, 
                                        ...
                                        int *infocode);
/* bigdft_finalize src/external.f90:120 */
/* Fortran header:
...
/* bigdft_init_mpi_env src/external.f90:72 */
/* Fortran header:
...
void FC_FUNC_(bigdft_init_mpi_env, BIGDFT_INIT_MPI_ENV)(int *mpi_info, 
                                                        ...
                                                        int *ierr);
/* bigdft_init_mpi_force src/external.f90:111 */
/* Fortran header:
...
void FC_FUNC_(bigdft_init_mpi_force, BIGDFT_INIT_MPI_FORCE)(const int *igroup, 
                                                            const int *ngroup);
/* bigdft_mpi_init src/external.f90:56 */
/* Fortran header:
...
/* check_linear_and_create_lzd src/linear/initAndUtils.f90:299 */
/* Fortran header:
...
/* createeffectiveionicpotential src/init/ionicpot.f90:482 */
/* Fortran header:
...
/* createprojectorsarrays src/init.f90:223 */
/* Fortran header:
subroutine createProjectorsArrays(lr,rxyz,at,orbs,cpmult,fpmult,hx,hy,hz,dry_run,nl,init_projectors_completely_)
use module_base
use psp_projectors
use module_types
...
void FC_FUNC(createprojectorsarrays, CREATEPROJECTORSARRAYS)(const f90_locreg_descriptors *lr, 
                                                             ...
                                                             const int *init_projectors_completely_);
...
/* density_descriptors src/init/denspotd.f90:566 */
/* Fortran header:
...
void FC_FUNC_(density_descriptors, DENSITY_DESCRIPTORS)(const int *iproc, 
                                                        ...
                                                        int str_ln_1);
/* denspot_communications src/init/denspotd.f90:209 */
/* Fortran header:
...
void FC_FUNC_(denspot_communications, DENSPOT_COMMUNICATIONS)(const int *iproc, 
                                                              ...
                                                              int str_ln_1, 
                                                              int str_ln_2);
/* denspot_full_density src/init/denspotd.f90:267 src/init/denspotd.f90:362 */
/* Fortran header:
...
void FC_FUNC_(denspot_full_density, DENSPOT_FULL_DENSITY)(const f90_DFT_local_fields *denspot, 
                                                          ...
                                                          const int *iproc, 
                                                          int *new);
/* denspot_full_v_ext src/init/denspotd.f90:316 src/init/denspotd.f90:416 */
/* Fortran header:
...
void FC_FUNC_(denspot_full_v_ext, DENSPOT_FULL_V_EXT)(const f90_DFT_local_fields *denspot, 
                                                      ...
                                                      const int *iproc, 
                                                      int *new);
/* dict_append src/bindings/bindingsf.f90:1752 */
/* Fortran header:
...
/* dict_dump src/bindings/bindingsf.f90:1772 */
/* Fortran header:
...
void FC_FUNC_(dict_dump, DICT_DUMP)(f90_dictionary_pointer *dict, 
                                    const int *unit);
/* dict_dump_to_file src/bindings/bindingsf.f90:1787 */
/* Fortran header:
...
void FC_FUNC_(dict_dump_to_file, DICT_DUMP_TO_FILE)(f90_dictionary_pointer *dict, 
                                                    ...
                                                    int str_ln_1);
/* dict_free_binding  */
/* dict_init_binding src/bindings/bindingsf.f90:1922 */
/* Fortran header:
...
/* dict_insert src/bindings/bindingsf.f90:1741 */
/* Fortran header:
...
void FC_FUNC_(dict_insert, DICT_INSERT)(f90_dictionary_pointer *dict, 
                                        const char *key, 
                                        int str_ln_1);
/* dict_iter src/bindings/bindingsf.f90:1856 */
/* Fortran header:
...
void FC_FUNC_(dict_iter, DICT_ITER)(f90_dictionary_pointer *dict, 
                                    int *exists);
/* dict_key src/bindings/bindingsf.f90:1846 */
/* Fortran header:
...
void FC_FUNC_(dict_key, DICT_KEY)(f90_dictionary_pointer *dict, 
                                  char *buf, 
                                  int str_ln_1);
/* dict_len src/bindings/bindingsf.f90:1884 */
/* Fortran header:
...
void FC_FUNC_(dict_len, DICT_LEN)(f90_dictionary_pointer *dict, 
                                  int *ln);
/* dict_move_to_item src/bindings/bindingsf.f90:1729 */
/* Fortran header:
...
void FC_FUNC_(dict_move_to_item, DICT_MOVE_TO_ITEM)(f90_dictionary_pointer *dict, 
                                                    int *exists, 
                                                    const int *id);
/* dict_move_to_key src/bindings/bindingsf.f90:1717 */
/* Fortran header:
...
void FC_FUNC_(dict_move_to_key, DICT_MOVE_TO_KEY)(f90_dictionary_pointer *dict, 
                                                  ...
                                                  const char *key, 
                                                  int str_ln_1);
/* dict_next src/bindings/bindingsf.f90:1870 */
/* Fortran header:
...
void FC_FUNC_(dict_next, DICT_NEXT)(f90_dictionary_pointer *dict, 
                                    int *exists);
/* dict_parse src/bindings/bindingsf.f90:1804 */
/* Fortran header:
...
void FC_FUNC_(dict_parse, DICT_PARSE)(f90_dictionary_pointer *dict, 
                                      const char *buf, 
                                      int str_ln_1);
/* dict_pop src/bindings/bindingsf.f90:1821 */
/* Fortran header:
...
void FC_FUNC_(dict_pop, DICT_POP)(f90_dictionary_pointer *dict, 
                                  ...
                                  const char *key, 
                                  int str_ln_1);
/* dict_put src/bindings/bindingsf.f90:1761 */
/* Fortran header:
...
void FC_FUNC_(dict_put, DICT_PUT)(f90_dictionary_pointer *dict, 
                                  const char *val, 
                                  int str_ln_1);
/* dict_size src/bindings/bindingsf.f90:1894 */
/* Fortran header:
...
void FC_FUNC_(dict_size, DICT_SIZE)(f90_dictionary_pointer *dict, 
                                    int *ln);
/* dict_update_binding src/bindings/bindingsf.f90:1913 */
/* Fortran header:
...
/* dict_value_binding src/bindings/bindingsf.f90:1836 */
/* Fortran header:
...
void FC_FUNC_(dict_value_binding, DICT_VALUE_BINDING)(f90_dictionary_pointer *dict, 
                                                      char *buf, 
                                                      int str_ln_1);
/* dpbox_set_box src/init/denspotd.f90:142 */
/* Fortran header:
...
/* energs_copy_data src/bindings/bindingsf.f90:1349 */
/* Fortran header:
...
void FC_FUNC(geopt, GEOPT)(f90_run_objects *runObj, 
                           ...
                           const int *iproc, 
                           int *ncount_bigdft);
/* glr_copy src/bindings/bindingsf.f90:203 */
/* Fortran header:
...
/* glr_empty src/bindings/bindingsf.f90:253 */
/* Fortran header:
...
/* glr_free src/bindings/bindingsf.f90:244 */
/* Fortran header:
...
/* glr_get_data src/bindings/bindingsf.f90:232 */
/* Fortran header:
...
void FC_FUNC_(glr_get_data, GLR_GET_DATA)(f90_locreg_descriptors *glr, 
                                          f90_grid_dimensions_pointer *d, 
                                          f90_wavefunctions_descriptors_pointer *wfd);
/* glr_get_dimensions src/bindings/bindingsf.f90:262 */
/* Fortran header:
...
void FC_FUNC_(glr_get_dimensions, GLR_GET_DIMENSIONS)(const f90_locreg_descriptors *glr, 
                                                      ...
                                                      int *nfu, 
                                                      int *norb);
/* glr_get_locreg_data src/bindings/bindingsf.f90:323 */
/* Fortran header:
...
void FC_FUNC_(glr_get_psi_size, GLR_GET_PSI_SIZE)(const f90_locreg_descriptors *glr, 
                                                  int *psisize);
/* glr_init src/bindings/bindingsf.f90:219 */
/* Fortran header:
...
void FC_FUNC_(glr_init, GLR_INIT)(f90_locreg_descriptors *glr, 
                                  f90_grid_dimensions_pointer *d, 
                                  f90_wavefunctions_descriptors_pointer *wfd);
/* glr_new src/bindings/bindingsf.f90:194 */
/* Fortran header:
...
/* glr_set_bounds src/bindings/bindingsf.f90:368 */
/* Fortran header:
...
/* glr_set_dimensions src/bindings/bindingsf.f90:294 */
/* Fortran header:
...
void FC_FUNC_(glr_set_dimensions, GLR_SET_DIMENSIONS)(f90_locreg_descriptors *glr, 
                                                      ...
                                                      const int *nfl, 
                                                      const int *nfu);
/* glr_set_wave_descriptors src/bindings/bindingsf.f90:349 */
/* Fortran header:
...
/* glr_set_wfd_dims src/bindings/bindingsf.f90:335 */
/* Fortran header:
...
void FC_FUNC_(glr_set_wfd_dims, GLR_SET_WFD_DIMS)(f90_locreg_descriptors *glr, 
                                                  ...
                                                  const int *nvctr_c, 
                                                  const int *nvctr_f);
/* glr_wfd_get_data src/bindings/bindingsf.f90:379 */
/* Fortran header:
...
/* gpu_free src/bindings/bindingsf.f90:1109 */
/* Fortran header:
...
/* gpu_new src/bindings/bindingsf.f90:1100 */
/* Fortran header:
...
/* image_calculate src/images.f90:1168 */
/* Fortran header:
...
void FC_FUNC_(image_calculate, IMAGE_CALCULATE)(f90_run_image *img, 
                                                int *iteration, 
                                                const int *id);
/* image_free src/images.f90:1288 */
/* Fortran header:
...
/* image_get_attributes src/images.f90:1308 */
/* Fortran header:
...
void FC_FUNC_(image_get_attributes, IMAGE_GET_ATTRIBUTES)(const f90_run_image *img, 
                                                          ...
                                                          double *F, 
                                                          int *id);
/* images_distribute_tasks src/images.f90:1214 */
/* Fortran header:
...
void FC_FUNC_(images_distribute_tasks, IMAGES_DISTRIBUTE_TASKS)(int *igroup, 
                                                                ...
                                                                const int *nimages, 
                                                                const int *ngroup);
/* image_update_pos src/images.f90:985 */
/* Fortran header:
...
/* image_update_pos_from_file src/images.f90:1083 */
/* Fortran header:
...
void FC_FUNC_(initialize_dft_local_fields, INITIALIZE_DFT_LOCAL_FIELDS)(f90_DFT_local_fields *denspot, 
                                                                        const int *ixc, 
                                                                        const int *nspden);
/* init_orbitals_data_for_linear src/linear/initAndUtils.f90:593 */
/* Fortran header:
...
void FC_FUNC_(inputs_check_psi_id, INPUTS_CHECK_PSI_ID)(int *inputpsi, 
                                                        ...
                                                        const int *nproc, 
                                                        int str_ln_1);
/* inputs_free src/bindings/bindingsf.f90:521 */
/* Fortran header:
...
/* inputs_get_dft src/bindings/bindingsf.f90:557 */
/* Fortran header:
...
/* inputs_get_mix src/bindings/bindingsf.f90:602 */
/* Fortran header:
...
void FC_FUNC(ionicenergyandforces, IONICENERGYANDFORCES)(const int *iproc, 
                                                         ...
                                                         const f90_coulomb_operator *pkernel, 
                                                         double *psoffset);
/* kernel_get_comm src/bindings/bindingsf.f90:933 */
/* Fortran header:
...
void FC_FUNC_(kernel_get_comm, KERNEL_GET_COMM)(const f90_coulomb_operator *pkernel, 
                                                ...
                                                int *nproc_grp, 
                                                int *mpi_comm);
/* kswfn_init_comm src/init/kswfn.f90:116 */
/* Fortran header:
...
/* kswfn_mpi_copy src/init/kswfn.f90:97 */
/* Fortran header:
...
void FC_FUNC_(kswfn_mpi_copy, KSWFN_MPI_COPY)(double *psic, 
                                              ...
                                              const int *psiStart, 
                                              const int *psiSize);
/* kswfn_optimization_loop src/cluster.f90:1346 */
/* Fortran header:
...
void FC_FUNC_(kswfn_optimization_loop, KSWFN_OPTIMIZATION_LOOP)(const int *iproc, 
                                                                ...
                                                                double *xcstr, 
                                                                const f90_input_variables *in);
/* kswfn_post_treatments src/cluster.f90:1735 */
/* Fortran header:
...
void FC_FUNC_(kswfn_post_treatments, KSWFN_POST_TREATMENTS)(const int *iproc, 
                                                            ...
                                                            int str_ln_1, 
                                                            int str_ln_2);
/* localfields_copy_metadata src/bindings/bindingsf.f90:1009 */
/* Fortran header:
...
void FC_FUNC_(localfields_copy_metadata, LOCALFIELDS_COPY_METADATA)(const f90_DFT_local_fields *denspot, 
                                                                    ...
                                                                    int *ni, 
                                                                    double *psoffset);
/* localfields_free src/bindings/bindingsf.f90:974 */
/* Fortran header:
...
void FC_FUNC_(localfields_free, LOCALFIELDS_FREE)(f90_DFT_local_fields_pointer *denspotd, 
                                                  f90_pointer_double_2D *fion, 
                                                  f90_pointer_double_2D *fdisp);
/* localfields_get_data src/bindings/bindingsf.f90:962 */
/* Fortran header:
...
/* localfields_get_pkernel src/bindings/bindingsf.f90:1058 */
/* Fortran header:
...
/* localfields_get_pkernelseq src/bindings/bindingsf.f90:1068 */
/* Fortran header:
...
/* localfields_new src/bindings/bindingsf.f90:947 */
/* Fortran header:
...
void FC_FUNC_(localfields_new, LOCALFIELDS_NEW)(const long *self, 
                                                ...
                                                f90_rho_descriptors_pointer *rhod, 
                                                f90_denspot_distribution_pointer *dpbox);
/* lzd_copy_data src/bindings/bindingsf.f90:430 */
/* Fortran header:
...
void FC_FUNC_(lzd_copy_data, LZD_COPY_DATA)(const f90_local_zone_descriptors *lzd, 
                                            int *nlr);
/* lzd_empty src/bindings/bindingsf.f90:450 */
/* Fortran header:
...
/* lzd_free src/bindings/bindingsf.f90:440 */
/* Fortran header:
...
/* lzd_get_data src/bindings/bindingsf.f90:420 */
/* Fortran header:
...
/* lzd_get_hgrids src/bindings/bindingsf.f90:485 */
/* Fortran header:
...
void FC_FUNC_(lzd_get_hgrids, LZD_GET_HGRIDS)(const f90_local_zone_descriptors *Lzd, 
                                              double *hgrids);
/* lzd_get_llr src/bindings/bindingsf.f90:496 */
/* Fortran header:
...
/* lzd_init src/bindings/bindingsf.f90:408 */
/* Fortran header:
...
void FC_FUNC_(lzd_init, LZD_INIT)(f90_local_zone_descriptors *lzd, 
                                  f90_locreg_descriptors_pointer *glr);
/* lzd_init_llr src/linear/initAndUtils.f90:697 */
/* Fortran header:
...
void FC_FUNC_(lzd_init_llr, LZD_INIT_LLR)(const int *iproc, 
                                          ...
                                          const f90_orbitals_data *orbs, 
                                          f90_local_zone_descriptors *lzd);
/* lzd_new src/bindings/bindingsf.f90:399 */
/* Fortran header:
...
/* lzd_set_hgrids src/init/wavefunctions.f90:379 */
/* Fortran header:
...
void FC_FUNC_(lzd_set_hgrids, LZD_SET_HGRIDS)(f90_local_zone_descriptors *Lzd, 
                                              const double *hgrids);
/* lzd_set_nlr src/bindings/bindingsf.f90:459 */
/* Fortran header:
...
void FC_FUNC_(lzd_set_nlr, LZD_SET_NLR)(f90_local_zone_descriptors *lzd, 
                                        ...
                                        const char *geocode, 
                                        int str_ln_1);
/* mem_destroy src/bindings/bindingsf.f90:1680 */
/* Fortran header:
...
/* mem_new src/bindings/bindingsf.f90:1671 */
/* Fortran header:
...
/* mem_to_c src/bindings/bindingsf.f90:1690 */
/* Fortran header:
...
/* optloop_bcast src/bindings/bindingsf.f90:1500 */
/* Fortran header:
...
void FC_FUNC_(optloop_bcast, OPTLOOP_BCAST)(f90_DFT_optimization_loop *optloop, 
                                            const int *iproc);
/* optloop_copy_data src/bindings/bindingsf.f90:1394 */
/* Fortran header:
...
void FC_FUNC_(optloop_copy_data, OPTLOOP_COPY_DATA)(const f90_DFT_optimization_loop *optloop, 
                                                    ...
                                                    int *iscf, 
                                                    int *infocode);
/* optloop_free src/bindings/bindingsf.f90:1385 */
/* Fortran header:
...
/* optloop_new src/bindings/bindingsf.f90:1374 */
/* Fortran header:
...
/* optloop_sync_data src/bindings/bindingsf.f90:1420 */
/* Fortran header:
...
void FC_FUNC_(optloop_sync_data, OPTLOOP_SYNC_DATA)(f90_DFT_optimization_loop *optloop, 
                                                    ...
                                                    const int *iscf, 
                                                    const int *infocode);
/* orbs_comm_empty src/bindings/bindingsf.f90:783 */
/* Fortran header:
...
/* orbs_comm_free src/bindings/bindingsf.f90:771 */
/* Fortran header:
...
/* orbs_comm_init src/bindings/bindingsf.f90:756 */
/* Fortran header:
...
void FC_FUNC_(orbs_comm_init, ORBS_COMM_INIT)(f90_comms_cubic *comms, 
                                              ...
                                              const int *iproc, 
                                              const int *nproc);
/* orbs_comm_new src/bindings/bindingsf.f90:743 */
/* Fortran header:
...
/* orbs_empty src/bindings/bindingsf.f90:734 */
/* Fortran header:
...
/* orbs_free src/bindings/bindingsf.f90:724 */
/* Fortran header:
...
/* orbs_get_dimensions src/bindings/bindingsf.f90:797 */
/* Fortran header:
...
void FC_FUNC_(orbs_get_dimensions, ORBS_GET_DIMENSIONS)(const f90_orbitals_data *orbs, 
                                                        ...
                                                        int *isorb, 
                                                        int *iskpts);
/* orbs_get_iorbp src/bindings/bindingsf.f90:1246 */
/* Fortran header:
...
void FC_FUNC_(orbs_get_iorbp, ORBS_GET_IORBP)(const f90_orbitals_data *orbs, 
                                              ...
                                              const int *ispin, 
                                              const int *ispinor);
/* orbs_init src/bindings/bindingsf.f90:715 */
/* Fortran header:
...
/* orbs_new src/bindings/bindingsf.f90:706 */
/* Fortran header:
...
/* orbs_open_file src/bindings/bindingsf.f90:883 */
/* Fortran header:
...
void FC_FUNC_(orbs_open_file, ORBS_OPEN_FILE)(const f90_orbitals_data *orbs, 
                                              ...
                                              const int *ispinor, 
                                              int str_ln_1);
/* print_memory_estimation src/output.f90:1481 */
/* Fortran header:
...
/* proj_free src/bindings/bindingsf.f90:911 */
/* Fortran header:
...
/* proj_get_dimensions src/bindings/bindingsf.f90:922 */
/* Fortran header:
...
void FC_FUNC_(proj_get_dimensions, PROJ_GET_DIMENSIONS)(const f90_DFT_PSP_projectors *nlpspd, 
                                                        int *nproj, 
                                                        int *nprojel);
/* proj_new src/bindings/bindingsf.f90:902 */
/* Fortran header:
...
/* read_wave_descr src/restart.f90:687 */
/* Fortran header:
...
void FC_FUNC_(read_wave_descr, READ_WAVE_DESCR)(int *lstat, 
                                                ...
                                                int *ispinor, 
                                                int str_ln_1);
/* read_wave_to_isf src/restart.f90:636 */
/* Fortran header:
...
void FC_FUNC_(read_wave_to_isf, READ_WAVE_TO_ISF)(int *lstat, 
                                                  ...
                                                  int str_ln_1);
/* run_objects_destroy src/bindings/bindingsf.f90:1560 */
/* Fortran header:
...
/* run_objects_dump_to_file src/bindings/bindingsf.f90:1588 */
/* Fortran header:
...
void FC_FUNC_(run_objects_dump_to_file, RUN_OBJECTS_DUMP_TO_FILE)(int *iostat, 
                                                                  ...
                                                                  const int *ln, 
                                                                  int str_ln_1);
/* run_objects_get src/bindings/bindingsf.f90:1571 */
/* Fortran header:
...
/* run_objects_init_from_run_name src/modules/bigdft_run.f90:1715 */
/* Fortran header:
...
void FC_FUNC_(run_objects_init_from_run_name, RUN_OBJECTS_INIT_FROM_RUN_NAME)(f90_run_objects *runObj, 
                                                                              ...
                                                                              int str_ln_1, 
                                                                              int str_ln_2);
/* run_objects_new src/bindings/bindingsf.f90:1539 */
/* Fortran header:
...
/* run_objects_nullify_dict src/bindings/bindingsf.f90:1652 */
/* Fortran header:
...
/* run_objects_nullify_volatile src/bindings/bindingsf.f90:1661 */
/* Fortran header:
...
/* run_objects_system_setup src/modules/bigdft_run.f90:1773 */
/* Fortran header:
...
void FC_FUNC_(run_objects_system_setup, RUN_OBJECTS_SYSTEM_SETUP)(f90_run_objects *runObj, 
                                                                  ...
                                                                  double *shift, 
                                                                  f90_memory_estimation *mem);
/* run_objects_update src/modules/bigdft_run.f90:1735 */
/* Fortran header:
...
void FC_FUNC_(run_objects_update, RUN_OBJECTS_UPDATE)(f90_run_objects *runObj, 
                                                      f90_dictionary_pointer *dict);
/* state_properties_alloc src/bindings/bindingsf.f90:1274 */
/* Fortran header:
...
void FC_FUNC_(state_properties_alloc, STATE_PROPERTIES_ALLOC)(f90_state_properties_pointer *outs, 
                                                              const int *nat);
/* state_properties_c_obj src/bindings/bindingsf.f90:1339 */
/* Fortran header:
...
void FC_FUNC_(state_properties_c_obj, STATE_PROPERTIES_C_OBJ)(const f90_state_properties *outs, 
                                                              long *c_obj);
/* state_properties_copy src/bindings/bindingsf.f90:1286 */
/* Fortran header:
...
/* state_properties_delete src/bindings/bindingsf.f90:1298 */
/* Fortran header:
...
/* state_properties_get src/bindings/bindingsf.f90:1307 */
/* Fortran header:
...
void FC_FUNC_(state_properties_get, STATE_PROPERTIES_GET)(const f90_state_properties *outs, 
                                                          ...
                                                          double *strten, 
                                                          double *etot);
/* state_properties_set_c_obj src/bindings/bindingsf.f90:1331 */
/* Fortran header:
...
/* system_createkernels src/init/sysprop.f90:389 */
/* Fortran header:
...
void FC_FUNC_(system_createkernels, SYSTEM_CREATEKERNELS)(f90_DFT_local_fields *denspot, 
                                                          const int *verb);
/* system_initkernels src/init/sysprop.f90:360 */
/* Fortran header:
...
void FC_FUNC_(system_size, SYSTEM_SIZE)(f90_atoms_data *atoms, 
                                        ...
                                        f90_locreg_descriptors *Glr, 
                                        double *shift);
/* update_wavefunctions_size src/linear/initAndUtils.f90:1026 */
/* Fortran header:
...
void FC_FUNC_(update_wavefunctions_size, UPDATE_WAVEFUNCTIONS_SIZE)(const f90_local_zone_descriptors *lzd, 
                                                                    ...
                                                                    const int *iproc, 
                                                                    const int *nproc);
/* wf_empty src/bindings/bindingsf.f90:1166 */
/* Fortran header:
...
/* wf_free src/bindings/bindingsf.f90:1179 */
/* Fortran header:
...
/* wf_get_data src/bindings/bindingsf.f90:1151 */
/* Fortran header:
...
/* wf_get_psi src/bindings/bindingsf.f90:1192 */
/* Fortran header:
...
void FC_FUNC_(wf_get_psi, WF_GET_PSI)(const f90_DFT_wavefunction *wf, 
                                      long *psi, 
                                      long *hpsi);
/* wf_get_psi_size src/bindings/bindingsf.f90:1210 */
/* Fortran header:
...
void FC_FUNC_(wf_get_psi_size, WF_GET_PSI_SIZE)(f90_pointer_double *psi, 
                                                long *psiSize);
/* wf_iorbp_to_psi src/bindings/bindingsf.f90:1221 */
/* Fortran header:
...
void FC_FUNC_(wf_iorbp_to_psi, WF_IORBP_TO_PSI)(double *psir, 
                                                const double *psi, 
                                                const f90_locreg_descriptors *lr);
/* wf_new src/bindings/bindingsf.f90:1118 */
/* Fortran header:
...
void FC_FUNC_(wf_new, WF_NEW)(const long *self, 
                              ...
                              f90_comms_cubic_pointer *comm, 
                              f90_local_zone_descriptors_pointer *lzd);
/* writeonewave src/wavelib/i-o.f90:971 */
/* Fortran header:
...
void FC_FUNC(writeonewave, WRITEONEWAVE)(int *unitwf, 
                                         ...
                                         const double *psi_f, 
                                         const double *eval);
/* writeonewave_linear src/restart.f90:725 */
/* Fortran header:
