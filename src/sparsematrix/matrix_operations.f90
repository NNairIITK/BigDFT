      ...
      subroutine overlapPowerGeneral(iproc, nproc, comm, iorder, ncalc, power, blocksize, imode, &
        ...
        sparse_dense: if (imode==DENSE) then
            ...
            if (iorder==0) then
                ...
                call transform_sparse_matrix_local(iproc, ovrlp_smat, inv_ovrlp_smat, 'small_to_large', &
                ...
                if (iorder<1000) then
                    ...
                    call transform_sparse_matrix(iproc, ovrlp_smat, inv_ovrlp_smat, 'small_to_large', &
        ...
        !!if(blocksize<0) then
           ...
           if (nproc>1) then
              call mpi_allgatherv(inv_ovrlp_halfp, norb*norbp, mpi_double_precision, inv_ovrlp_half, &
                         norb*smat%nfvctr_par(:), norb*smat%isfvctr_par, mpi_double_precision, comm, ierr)
           else
