...
extern "C" {
#endif /* __cplusplus */
int FC_FUNC(cublas_init,CUBLAS_INIT) (void);
int FC_FUNC(cublas_shutdown,CUBLAS_SHUTDOWN) (void);
int FC_FUNC(cublas_alloc,CUBLAS_ALLOC) (const int *n, const int *elemSize, devptr_t *devicePtr);
int FC_FUNC(cublas_free,CUBLAS_FREE) (const devptr_t *devicePtr);
int FC_FUNC(cublas_set_vector,CUBLAS_SET_VECTOR) (const int *n, const int *elemSize, const void *x,
                       const int *incx, const devptr_t *y, const int *incy);
int FC_FUNC(cublas_get_vector,CUBLAS_GET_VECTOR) (const int *n, const int *elemSize, const devptr_t *x,
                       const int *incx, void *y, const int *incy);
int FC_FUNC(cublas_set_matrix,CUBLAS_SET_MATRIX) (const int *rows, const int *cols, const int *elemSize,
                       const void *A, const int *lda, const int *B, 
                       const int *ldb);
int FC_FUNC(cublas_get_matrix,CUBLAS_GET_MATRIX) (const int *rows, const int *cols, const int *elemSize,
                       const int *A, const int *lda, void *B, const int *ldb);

/* BLAS util */
void FC_FUNC(cublas_xerbla,CUBLAS_XERBLA) (const char *srName, int *info);
#if defined(__cplusplus)
}
#endif /* __cplusplus */
...
int FC_FUNC(cublas_get_error,CUBLAS_GET_ERROR) (void)
{
...
/* BLAS1 */
#if CUBLAS_FORTRAN_COMPILER==CUBLAS_G77
double FC_FUNC(cublas_sdot,CUBLAS_SDOT) (const int *n, const float *x, const int *incx, float *y, 
                    const int *incy);
double FC_FUNC(cublas_sasum,CUBLAS_SASUM) (const int *n, const float *x, const int *incx);
double FC_FUNC(cublas_snrm2,CUBLAS_SNRM2) (const int *n, const float *x, const int *incx);
double FC_FUNC(cublas_scasum,CUBLAS_SCASUM) (const int *n, const cuComplex *x, const int *incx);
double FC_FUNC(cublas_scnrm2,CUBLAS_SCNRM2) (const int *n, const cuComplex *x, const int *incx);
#else
float FC_FUNC(cublas_sdot,CUBLAS_SDOT) (const int *n, const float *x, const int *incx, float *y, 
                   const int *incy);
float FC_FUNC(cublas_sasum,CUBLAS_SASUM) (const int *n, const float *x, const int *incx);
float FC_FUNC(cublas_snrm2,CUBLAS_SNRM2) (const int *n, const float *x, const int *incx);
float FC_FUNC(cublas_scasum,CUBLAS_SCASUM) (const int *n, const cuComplex *x, const int *incx);
float FC_FUNC(cublas_scnrm2,CUBLAS_SCNRM2) (const int *n, const cuComplex *x, const int *incx);
#endif
int FC_FUNC(cublas_isamax,CUBLAS_ISAMAX) (const int *n, const float *x, const int *incx);
int FC_FUNC(cublas_isamin,CUBLAS_ISAMIN) (const int *n, const float *x, const int *incx);
void FC_FUNC(cublas_saxpy,CUBLAS_SAXPY) (const int *n, const float *alpha, const float *x, 
                   const int *incx, float *y, const int *incy);
void FC_FUNC(cublas_scopy,CUBLAS_SCOPY) (const int *n, const float *x, const int *incx, float *y, 
                   const int *incy);
void FC_FUNC(cublas_srot,CUBLAS_SROT) (const int *n, float *x, const int *incx, float *y, 
                  const int *incy, const float *sc, const float *ss);
void FC_FUNC(cublas_srotg,CUBLAS_SROTG) (float *sa, float *sb, float *sc, float *ss);
void FC_FUNC(cublas_srotm,CUBLAS_SROTM) (const int *n, float *x, const int *incx, float *y,
                   const int *incy, const float* sparam);
void FC_FUNC(cublas_srotmg,CUBLAS_SROTMG) (float *sd1, float *sd2, float *sx1, const float *sy1, 
                    float* sparam);
void FC_FUNC(cublas_sscal,CUBLAS_SSCAL) (const int *n, const float *alpha, float *x,
                   const int *incx);
void FC_FUNC(cublas_sswap,CUBLAS_SSWAP)(const int *n, float *x, const int *incx, float *y,
                  const int *incy);

void FC_FUNC(cublas_caxpy,CUBLAS_CAXPY) (const int *n, const cuComplex *alpha, const cuComplex *x, 
                   const int *incx, cuComplex *y, const int *incy);
void FC_FUNC(cublas_ccopy,CUBLAS_CCOPY) (const int *n, const cuComplex *x, const int *incx, 
                   cuComplex *y, const int *incy);
void FC_FUNC(cublas_crot,CUBLAS_CROT) (const int *n, cuComplex *x, const int *incx, cuComplex *y, 
                  const int *incy, const float *sc, const cuComplex *cs);
void FC_FUNC(cublas_crotg,CUBLAS_CROTG) (cuComplex *ca, const cuComplex *cb, float *sc, 
                   cuComplex *cs);
void FC_FUNC(cublas_cscal,CUBLAS_CSCAL) (const int *n, const cuComplex *alpha, cuComplex *x, 
                   const int *incx);
void FC_FUNC(cublas_csrot,CUBLAS_CSROT) (const int *n, cuComplex *x, const int *incx, cuComplex *y, 
                   const int *incy, const float *sc, const float *ss);
void FC_FUNC(cublas_csscal,CUBLAS_CSSCAL) (const int *n, const float *alpha, cuComplex *x,
                    const int *incx);
void FC_FUNC(cublas_cswap,CUBLAS_CSWAP) (const int *n, cuComplex *x, const int *incx, cuComplex *y,
                   const int *incy);
void FC_FUNC(cublas_cdotu,CUBLAS_CDOTU) (cuComplex *retVal, const int *n, const cuComplex *x, 
                   const int *incx, const cuComplex *y, const int *incy);
void FC_FUNC(cublas_cdotc,CUBLAS_CDOTC) (cuComplex *retVal,const int *n, const cuComplex *x, 
                   const int *incx, const cuComplex *y, const int *incy);
int FC_FUNC(cublas_icamax,CUBLAS_ICAMAX) (const int *n, const cuComplex *x, const int *incx);
int FC_FUNC(cublas_icamin,CUBLAS_ICAMIN) (const int *n, const cuComplex *x, const int *incx);

/* BLAS2 */
void FC_FUNC(cublas_sgbmv,CUBLAS_SGBMV) (const char *trans, const int *m, const int *n, 
                   const int *kl, const int *ku, const float *alpha, 
                   const float *A, const int *lda, const float *x,
                   const int *incx, const float *beta, float *y, 
                   const int *incy);
void FC_FUNC(cublas_sgemv,CUBLAS_SGEMV) (const char *trans, const int *m, const int *n,
                   const float *alpha, const float *A, const int *lda,
                   const float *x, const int *incx, const float *beta, 
                   float *y, const int *incy);
void FC_FUNC(cublas_sger,CUBLAS_SGER) (const int *m, const int *n, const float *alpha,
                  const float *x, const int *incx, const float *y,
                  const int *incy, float *A, const int *lda);
void FC_FUNC(cublas_ssbmv,CUBLAS_SSBMV) (const char *uplo, const int *n, const int *k, 
                   const float *alpha, const float *A, const int *lda,
                   const float *x, const int *incx, const float *beta,
                   float *y, const int *incy);
void FC_FUNC(cublas_sspmv,CUBLAS_SSPMV) (const char *uplo, const int *n, const float *alpha, 
                   const float *AP, const float *x, const int *incx, 
                   const float *beta, float *y, const int *incy);
void FC_FUNC(cublas_sspr,CUBLAS_SSPR) (const char *uplo, const int *n, const float *alpha,
                  const float *x, const int *incx, float *AP);
void FC_FUNC(cublas_sspr2,CUBLAS_SSPR2) (const char *uplo, const int *n, const float *alpha,
                   const float *x, const int *incx, const float *y,
                   const int *incy, float *AP);
void FC_FUNC(cublas_ssymv,CUBLAS_SSYMV) (const char *uplo, const int *n, const float *alpha,
                   const float *A, const int *lda, const float *x,
                   const int *incx, const float *beta, float *y, 
                   const int *incy);
void FC_FUNC(cublas_ssyr,CUBLAS_SSYR) (const char *uplo, const int *n, const float *alpha,
                  const float *x, const int *incx, float *A, const int *lda);
void FC_FUNC(cublas_ssyr2,CUBLAS_SSYR2) (const char *uplo, const int *n, const float *alpha,
                   const float *x, const int *incx, const float *y,
                   const int *incy, float *A, const int *lda);
void FC_FUNC(cublas_stbmv,CUBLAS_STBMV) (const char *uplo, const char *trans, const char *diag, 
                   const int *n, const int *k, const float *A, const int *lda, 
                   float *x, const int *incx);
void FC_FUNC(cublas_stbsv,CUBLAS_STBSV) (const char *uplo, const char *trans, const char *diag, 
                   const int *n, const int *k, const float *A, const int *lda, 
                   float *x, const int *incx);
void FC_FUNC(cublas_stpmv,CUBLAS_STPMV) (const char *uplo, const char *trans, const char *diag, 
                   const int *n, const float *AP, float *x, const int *incx);
void FC_FUNC(cublas_stpsv,CUBLAS_STPSV) (const char *uplo, const char *trans, const char *diag, 
                   const int *n, const float *AP, float *x, const int *incx);
void FC_FUNC(cublas_strmv,CUBLAS_STRMV) (const char *uplo, const char *trans, const char *diag, 
                   const int *n, const float *A, const int *lda, float *x, 
                   const int *incx);
void FC_FUNC(cublas_strsv,CUBLAS_STRSV) (const char *uplo, const char *trans, const char *diag, 
                   const int *n, const float *A, const int *lda, float *x, 
                   const int *incx);

/* BLAS3 */
void FC_FUNC(cublas_sgemm,CUBLAS_SGEMM) (const char *transa, const char *transb, const int *m,
                   const int *n, const int *k, const float *alpha, 
                   const float *A, const int *lda, const float *B, 
                   const int *ldb, const float *beta, float *C, 
                   const int *ldc);
void FC_FUNC(cublas_ssymm,CUBLAS_SSYMM) (const char *side, const char *uplo, const int *m,
                   const int *n, const float *alpha, const float *A,
                   const int *lda, const float *B, const int *ldb, 
                   const float *beta, float *C, const int *ldc);
void FC_FUNC(cublas_ssyr2k,CUBLAS_SSYR2K) (const char *uplo, const char *trans, const int *n, 
                    const int *k, const float *alpha, const float *A,
                    const int *lda,const float *B, const int *ldb, 
                    const float *beta, float *C, const int *ldc);
void FC_FUNC(cublas_ssyrk,CUBLAS_SSYRK) (const char *uplo, const char *trans, const int *n,
                   const int *k, const float *alpha, const float *A,
                   const int *lda, const float *beta, float *C,
                   const int *ldc);
void FC_FUNC(cublas_strmm,CUBLAS_STRMM) (const char *side, const char *uplo, const char *transa, 
                   const char *diag, const int *m, const int *n,
                   const float *alpha, const float *A, const int *lda,
                   float *B, const int *ldb);
void FC_FUNC(cublas_strsm,CUBLAS_STRSM) (const char *side, const char *uplo, const char *transa, 
                   const char *diag, const int *m, const int *n,
                   const float *alpha, const float *A, const int *lda,
                   float *B, const int *ldb);

void FC_FUNC(cublas_cgemm,CUBLAS_CGEMM) (const char *transa, const char *transb, const int *m,
...
/* DP BLAS1 */
double FC_FUNC(cublas_ddot,CUBLAS_DDOT) (const int *n, const double *x, const int *incx, double *y, 
                   const int *incy);
double FC_FUNC(cublas_dasum,CUBLAS_DASUM) (const int *n, const double *x, const int *incx);
double FC_FUNC(cublas_dnrm2,CUBLAS_DNRM2) (const int *n, const double *x, const int *incx);
int FC_FUNC(cublas_idamax,CUBLAS_IDAMAX) (const int *n, const double *x, const int *incx);
int FC_FUNC(cublas_idamin,CUBLAS_IDAMIN) (const int *n, const double *x, const int *incx);
void FC_FUNC(cublas_daxpy,CUBLAS_DAXPY) (const int *n, const double *alpha, const double *x, 
                   const int *incx, double *y, const int *incy);
void FC_FUNC(cublas_dcopy,CUBLAS_DCOPY) (const int *n, const double *x, const int *incx, double *y, 
                   const int *incy);
void FC_FUNC(cublas_drot,CUBLAS_DROT) (const int *n, double *x, const int *incx, double *y, 
                  const int *incy, const double *sc, const double *ss);
void FC_FUNC(cublas_drotg,CUBLAS_DROTG) (double *sa, double *sb, double *sc, double *ss);
void FC_FUNC(cublas_drotm,CUBLAS_DROTM) (const int *n, double *x, const int *incx, double *y,
                   const int *incy, const double* sparam);
void FC_FUNC(cublas_drotmg,CUBLAS_DROTMG) (double *sd1, double *sd2, double *sx1, const double *sy1, 
                    double* sparam);
void FC_FUNC(cublas_dscal,CUBLAS_DSCAL) (const int *n, const double *alpha, double *x,
                   const int *incx);
void FC_FUNC(cublas_dswap,CUBLAS_DSWAP)(const int *n, double *x, const int *incx, double *y,
                  const int *incy);

/* DP BLAS2 */
void FC_FUNC(cublas_dgemv,CUBLAS_DGEMV) (const char *trans, const int *m, const int *n,
                   const double *alpha, const double *A, const int *lda,
                   const double *x, const int *incx, const double *beta, 
                   double *y, const int *incy);
void FC_FUNC(cublas_dger,CUBLAS_DGER) (const int *m, const int *n, const double *alpha,
                  const double *x, const int *incx, const double *y,
                  const int *incy, double *A, const int *lda);
void FC_FUNC(cublas_dsyr,CUBLAS_DSYR) (const char *uplo, const int *n, const double *alpha,
                  const double *x, const int *incx, double *A, const int *lda);
void FC_FUNC(cublas_dtrsv,CUBLAS_DTRSV) (const char *uplo, const char *trans, const char *diag, 
                   const int *n, const double *A, const int *lda, double *x, 
                   const int *incx);

/* DP BLAS3 */
void FC_FUNC(cublas_dgemm,CUBLAS_DGEMM) (const char *transa, const char *transb, const int *m,
                   const int *n, const int *k, const double *alpha, 
                   const double *A, const int *lda, const double *B, 
                   const int *ldb, const double *beta, double *C, 
                   const int *ldc);
void FC_FUNC(cublas_dsymm,CUBLAS_DSYMM) (const char *side, const char *uplo, const int *m,
                   const int *n, const double *alpha, const double *A,
                   const int *lda, const double *B, const int *ldb, 
                   const double *beta, double *C, const int *ldc);
void FC_FUNC(cublas_dsyr2k,CUBLAS_DSYR2K) (const char *uplo, const char *trans, const int *n, 
                    const int *k, const double *alpha, const double *A,
                    const int *lda,const double *B, const int *ldb, 
                    const double *beta, double *C, const int *ldc);
void FC_FUNC(cublas_dsyrk,CUBLAS_DSYRK) (const char *uplo, const char *trans, const int *n,
                   const int *k, const double *alpha, const double *A,
                   const int *lda, const double *beta, double *C,
                   const int *ldc);
void FC_FUNC(cublas_dtrmm,CUBLAS_DTRMM) (const char *side, const char *uplo, const char *transa, 
                   const char *diag, const int *m, const int *n,
                   const double *alpha, const double *A, const int *lda,
                   double *B, const int *ldb);
void FC_FUNC(cublas_dtrsm,CUBLAS_DTRSM) (const char *side, const char *uplo, const char *transa, 
                   const char *diag, const int *m, const int *n,
                   const double *alpha, const double *A, const int *lda,
                   double *B, const int *ldb);

void FC_FUNC(cublas_zgemm,CUBLAS_ZGEMM) (const char *transa, const char *transb, const int *m,
...
void FC_FUNC(cublas_sscal,CUBLAS_SSCAL) (const int *n, const float *alpha, float *x, const int *incx)
{
    float *devPtrx = 0;
    cublasStatus stat;
...
void FC_FUNC(cublas_strmv,CUBLAS_STRMV) (const char *uplo, const char *trans,
...
void FC_FUNC(cublas_dspr2,CUBLAS_DSPR2) (void)
{
    wrapperError ("Dspr2", CUBLAS_WRAPPER_ERROR_STUB);
}

void FC_FUNC(cublas_dsyr2,CUBLAS_DSYR2) (void)
{
    wrapperError ("Dsyr2", CUBLAS_WRAPPER_ERROR_STUB);
}

void FC_FUNC(cublas_dspr,CUBLAS_DSPR) (void)
{
    wrapperError ("Dspr", CUBLAS_WRAPPER_ERROR_STUB);
}

void FC_FUNC(cublas_dtpsv,CUBLAS_DTPSV) (void)
{
    wrapperError ("Dtpsv", CUBLAS_WRAPPER_ERROR_STUB);
}

void FC_FUNC(cublas_dtbsv,CUBLAS_DTBSV) (void)
{
    wrapperError ("Dtbsv", CUBLAS_WRAPPER_ERROR_STUB);
}

void FC_FUNC(cublas_dtpmv,CUBLAS_DTPMV) (void)
{
    wrapperError ("Dtpmv", CUBLAS_WRAPPER_ERROR_STUB);
}

void FC_FUNC(cublas_dtbmv,CUBLAS_DTBMV) (void)
{
    wrapperError ("Dtbmv", CUBLAS_WRAPPER_ERROR_STUB);
}

void FC_FUNC(cublas_dtrmv,CUBLAS_DTRMV) (void)
{
    wrapperError ("Dtrmv", CUBLAS_WRAPPER_ERROR_STUB);
}

void FC_FUNC(cublas_dspmv,CUBLAS_DSPMV) (void)
{
    wrapperError ("Dspmv", CUBLAS_WRAPPER_ERROR_STUB); 
}

void FC_FUNC(cublas_dsbmv,CUBLAS_DSBMV) (void)
{
    wrapperError ("Dsbmv", CUBLAS_WRAPPER_ERROR_STUB); 
} 

void FC_FUNC(cublas_dsymv,CUBLAS_DSYMV) (void)
{
    wrapperError ("Dsymv", CUBLAS_WRAPPER_ERROR_STUB); 
}

void FC_FUNC(cublas_dgbmv,CUBLAS_DGBMV) (void)
{
...
void FC_FUNC(cublas_chemm,CUBLAS_CHEMM) (void)
{
    wrapperError ("Chemm", CUBLAS_WRAPPER_ERROR_STUB);
}
void FC_FUNC(cublas_csymm,CUBLAS_CSYMM) (void)
{
    wrapperError ("Csymm", CUBLAS_WRAPPER_ERROR_STUB);
}
void FC_FUNC(cublas_ctrmm,CUBLAS_CTRMM) (void)
{
    wrapperError ("Ctrmm", CUBLAS_WRAPPER_ERROR_STUB);
}
void FC_FUNC(cublas_ctrsm,CUBLAS_CTRSM) (void)
{
    wrapperError ("Ctrsm", CUBLAS_WRAPPER_ERROR_STUB);
}
void FC_FUNC(cublas_cherk,CUBLAS_CHERK) (void)
{
    wrapperError ("CHerk", CUBLAS_WRAPPER_ERROR_STUB);
}
void FC_FUNC(cublas_csyrk,CUBLAS_CSYRK) (void)
{
    wrapperError ("CSyrk", CUBLAS_WRAPPER_ERROR_STUB);
}
void FC_FUNC(cublas_cher2k,CUBLAS_CHER2K) (void)
{
    wrapperError ("CHer2k", CUBLAS_WRAPPER_ERROR_STUB);
}
void FC_FUNC(cublas_csyr2k,CUBLAS_CSYR2K) (void)
{
...
void FC_FUNC(cublas_zhemm,CUBLAS_ZHEMM) (void)
{
    wrapperError ("ZHemm", CUBLAS_WRAPPER_ERROR_STUB);
}
void FC_FUNC(cublas_zsymm,CUBLAS_ZSYMM) (void)
{
    wrapperError ("ZSymm", CUBLAS_WRAPPER_ERROR_STUB);
}
void FC_FUNC(cublas_ztrmm,CUBLAS_ZTRMM) (void)
{
    wrapperError ("ZTrmm", CUBLAS_WRAPPER_ERROR_STUB);
}
void FC_FUNC(cublas_ztrsm,CUBLAS_ZTRSM) (void)
{
    wrapperError ("ZTrsm", CUBLAS_WRAPPER_ERROR_STUB);
}
void FC_FUNC(cublas_zherk,CUBLAS_ZHERK) (void)
{
    wrapperError ("ZHerk", CUBLAS_WRAPPER_ERROR_STUB);
}
void FC_FUNC(cublas_zsyrk,CUBLAS_ZSYRK) (void)
{
    wrapperError ("ZSyrk", CUBLAS_WRAPPER_ERROR_STUB);
}
void FC_FUNC(cublas_zher2k,CUBLAS_ZHER2K) (void)
{
    wrapperError ("ZHer2k", CUBLAS_WRAPPER_ERROR_STUB);
}
void FC_FUNC(cublas_zsyr2k,CUBLAS_ZSYR2K) (void)
{
...
#endif /* __cplusplus */
#if CUBLAS_FORTRAN_COMPILER==CUBLAS_G77
double FC_FUNC(cublas_sdot,CUBLAS_SDOT) (const int *n, const devptr_t *devPtrx, const int *incx, 
                    const devptr_t *devPtry, const int *incy);
double FC_FUNC(cublas_sasum,CUBLAS_SASUM) (const int *n, const devptr_t *devPtrx, const int *incx);
double FC_FUNC(cublas_snrm2,CUBLAS_SNRM2) (const int *n, const devptr_t *devPtrx, const int *incx);
double FC_FUNC(cublas_scasum,CUBLAS_SCASUM) (const int *n, const devptr_t *devPtrx, const int *incx);
double FC_FUNC(cublas_scnrm2,CUBLAS_SCNRM2) (const int *n, const devptr_t *devPtrx, const int *incx);
#else
float FC_FUNC(cublas_sdot,CUBLAS_SDOT) (const int *n, const devptr_t *devPtrx, const int *incx, 
                   const devptr_t *devPtry, const int *incy);
float FC_FUNC(cublas_sasum,CUBLAS_SASUM) (const int *n, const devptr_t *devPtrx, const int *incx);
float FC_FUNC(cublas_snrm2,CUBLAS_SNRM2) (const int *n, const devptr_t *devPtrx, const int *incx);
float FC_FUNC(cublas_scasum,CUBLAS_SCASUM) (const int *n, const devptr_t *devPtrx, const int *incx);
float FC_FUNC(cublas_scnrm2,CUBLAS_SCNRM2) (const int *n, const devptr_t *devPtrx, const int *incx);
#endif

int FC_FUNC(cublas_isamax,CUBLAS_ISAMAX) (const int *n, const devptr_t *devPtrx, const int *incx);
int FC_FUNC(cublas_isamin,CUBLAS_ISAMIN) (const int *n, const devptr_t *devPtrx, const int *incx);
void FC_FUNC(cublas_saxpy,CUBLAS_SAXPY) (const int *n, const float *alpha, const devptr_t *devPtrx, 
                   const int *incx, const devptr_t *devPtry, const int *incy);
void FC_FUNC(cublas_scopy,CUBLAS_SCOPY) (const int *n, const devptr_t *devPtrx, const int *incx, 
                   const devptr_t *devPtry, const int *incy);
void FC_FUNC(cublas_srot,CUBLAS_SROT) (const int *n, const devptr_t *devPtrX, const int *incx, 
                  const devptr_t *devPtrY, const int *incy, const float *sc, 
                  const float *ss);
void FC_FUNC(cublas_srotg,CUBLAS_SROTG) (float *sa, float *sb, float *sc, float *ss);
void FC_FUNC(cublas_srotm,CUBLAS_SROTM) (const int *n, const devptr_t *devPtrx, const int *incx, 
                   const devptr_t *devPtry, const int *incy, 
                   const float* sparam);
void FC_FUNC(cublas_srotmg,CUBLAS_SROTMG) (float *sd1, float *sd2, float *sx1, const float *sy1, 
                    float* sparam);
void FC_FUNC(cublas_sscal,CUBLAS_SSCAL) (const int *n, const float *alpha, const devptr_t *devPtrx,
                   const int *incx);
void FC_FUNC(cublas_sswap,CUBLAS_SSWAP) (const int *n, const devptr_t *devPtrx, const int *incx, 
                   const devptr_t *devPtry, const int *incy);

void FC_FUNC(cublas_caxpy,CUBLAS_CAXPY) (const int *n, const cuComplex *alpha,
                   const devptr_t *devPtrx, const int *incx, 
                   const devptr_t *devPtry, const int *incy);
void FC_FUNC(cublas_ccopy,CUBLAS_CCOPY) (const int *n, const devptr_t *devPtrx, const int *incx, 
                   const devptr_t *devPtry, const int *incy);
void FC_FUNC(cublas_crot,CUBLAS_CROT) (const int *n, const devptr_t *devPtrX, const int *incx, 
                  const devptr_t *devPtrY, const int *incy, const float *sc, 
                  const cuComplex *cs);
void FC_FUNC(cublas_crotg,CUBLAS_CROTG) (cuComplex *ca, const cuComplex *cb, float *sc,
                   cuComplex *cs);
void FC_FUNC(cublas_cscal,CUBLAS_CSCAL) (const int *n, const cuComplex *alpha, 
                   const devptr_t *devPtrx, const int *incx);
void FC_FUNC(cublas_csrot,CUBLAS_CSROT) (const int *n, const devptr_t *devPtrX, const int *incx, 
                   const devptr_t *devPtrY, const int *incy, const float *sc, 
                   const float *ss);
void FC_FUNC(cublas_csscal,CUBLAS_CSSCAL) (const int *n, const float *alpha, const devptr_t *devPtrx, 
                    const int *incx);
void FC_FUNC(cublas_cswap,CUBLAS_CSWAP) (const int *n, const devptr_t *devPtrx, const int *incx, 
                   const devptr_t *devPtry, const int *incy);
void FC_FUNC(cublas_cdotu,CUBLAS_CDOTU) (cuComplex *retVal, const int *n, const devptr_t *devPtrx, 
                   const int *incx, const devptr_t *devPtry, const int *incy);
void FC_FUNC(cublas_cdotc,CUBLAS_CDOTC) (cuComplex *retVal, const int *n, const devptr_t *devPtrx, 
                   const int *incx, const devptr_t *devPtry, const int *incy);
int FC_FUNC(cublas_icamax,CUBLAS_ICAMAX) (const int *n, const devptr_t *devPtrx, const int *incx);
int FC_FUNC(cublas_icamin,CUBLAS_ICAMIN) (const int *n, const devptr_t *devPtrx, const int *incx);
double FC_FUNC(cublas_ddot,CUBLAS_DDOT) (const int *n, const devptr_t *devPtrx, const int *incx, 
                   const devptr_t *devPtry, const int *incy);
double FC_FUNC(cublas_dasum,CUBLAS_DASUM) (const int *n, const devptr_t *devPtrx, const int *incx);
double FC_FUNC(cublas_dnrm2,CUBLAS_DNRM2) (const int *n, const devptr_t *devPtrx, const int *incx);
int FC_FUNC(cublas_idamax,CUBLAS_IDAMAX) (const int *n, const devptr_t *devPtrx, const int *incx);
int FC_FUNC(cublas_idamin,CUBLAS_IDAMIN) (const int *n, const devptr_t *devPtrx, const int *incx);
void FC_FUNC(cublas_daxpy,CUBLAS_DAXPY) (const int *n, const double *alpha, const devptr_t *devPtrx, 
                   const int *incx, const devptr_t *devPtry, const int *incy);
void FC_FUNC(cublas_dcopy,CUBLAS_DCOPY) (const int *n, const devptr_t *devPtrx, const int *incx, 
                   const devptr_t *devPtry, const int *incy);
void FC_FUNC(cublas_drot,CUBLAS_DROT) (const int *n, const devptr_t *devPtrX, const int *incx, 
                  const devptr_t *devPtrY, const int *incy, const double *sc, 
                  const double *ss);
void FC_FUNC(cublas_drotg,CUBLAS_DROTG) (double *sa, double *sb, double *sc, double *ss);
void FC_FUNC(cublas_drotm,CUBLAS_DROTM) (const int *n, const devptr_t *devPtrx, const int *incx, 
                   const devptr_t *devPtry, const int *incy, 
                   const double* sparam);
void FC_FUNC(cublas_drotmg,CUBLAS_DROTMG) (double *sd1, double *sd2, double *sx1, const double *sy1, 
                    double* sparam);
void FC_FUNC(cublas_dscal,CUBLAS_DSCAL) (const int *n, const double *alpha, const devptr_t *devPtrx,
                   const int *incx);
void FC_FUNC(cublas_dswap,CUBLAS_DSWAP) (const int *n, const devptr_t *devPtrx, const int *incx, 
                   const devptr_t *devPtry, const int *incy);
