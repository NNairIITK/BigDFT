...
!        PARAMETER(C=.35D0)! silicon
!        PARAMETER(C=.5D0)! SiH4
      c=-cprec
      call precondition( c,n1,n2,n3,nfl1,nfu1,nfl2,nfu2,nfl3,nfu3,hgrid,  &
                         nseg_c,nvctr_c,keyg(1,1),keyv(1),  & 
                         nseg_f,nvctr_f,keyg(1,nseg_c+1),keyv(nseg_c+1), & 
                         hpsi(1,iorb-iproc*norbp),hpsi(nvctr_c+1,iorb-iproc*norbp))
      ...
      subroutine precondition(c,n1,n2,n3,nfl1,nfu1,nfl2,nfu2,nfl3,nfu3,hgrid,  & 
                              nseg_c,nvctr_c,keyg_c,keyv_c,  & 
                              nseg_f,nvctr_f,keyg_f,keyv_f,psi_c,psi_f)
        implicit real*8 (a-h,o-z)
        ...
        PARAMETER(NSTEP=3,AUX2MAX=1.D-50)
        dimension aux(nstep)
        logical :: iwrite=.true.
        
        real*8,allocatable,dimension(:) ::   GG_C
        real*8,allocatable,dimension(:,:) :: GG_F

        allocate(GG_c(nvctr_c),GG_f(7,nvctr_f))

        tt=C*HGRID*HGRID*.25d0
        ALPHA=PIECELINE(tt)
        if (iwrite) then
        WRITE(*,*)'input,ALPHA_PR=',tt,ALPHA
        iwrite=.false.
        endif
        ...
        CALL prec_diag(n1,n2,n3,hgrid,nseg_c,nvctr_c,nvctr_f,keyg_c,keyv_c,psi_c,psi_f,C)
                         
        LOOP:DO ISTEP=1,NSTEP 

          call CALC_GRAD_REZA(n1,n2,n3,nl1_c,nu1_c,nl2_c,nu2_c,nl3_c,nu3_c,nl1_f,nu1_f,nl2_f,nu2_f,nl3_f,nu3_f, & 
                         nseg_c,nvctr_c,keyg_c,keyv_c,nseg_f,nvctr_f,keyg_f,keyv_f, & 
                         psi_c,psi_f,hgrid,gg_c,gg_f,C,hpsi_c,hpsi_f,hpsi2)
                         
          aux(istep)=hpsi2
          IF (HPSI2.LT.AUX2MAX) EXIT
          
          CALL prec_diag(n1,n2,n3,hgrid,nseg_c,nvctr_c,nvctr_f,keyg_c,keyv_c,&
                         hpsi_c,hpsi_f,C) 

          PSI_C=PSI_C-ALPHA*HPSI_C
          PSI_F=PSI_F-ALPHA*HPSI_F

        ENDDO LOOP

        WRITE(*,'(a,10(x,e9.2))') 'PRECOND ',aux

        DEALLOCATE(GG_C,GG_F) 
          
	end

          
       SUBROUTINE CALC_GRAD_REZA(n1,n2,n3,nl1_c,nu1_c,nl2_c,nu2_c,nl3_c,nu3_c,nl1_f,nu1_f,nl2_f,nu2_f,nl3_f,nu3_f, & 
                                 nseg_c,nvctr_c,keyg_c,keyv_c,nseg_f,nvctr_f,keyg_f,keyv_f, &
                                 psi_c,psi_f,hgrid,gg_c,gg_f,C,hpsi_c,hpsi_f,hpsi2) 
        implicit real*8 (a-h,o-z)        
        ...
        call uncompress_forstandard(n1,n2,n3,nl1_c,nu1_c,nl2_c,nu2_c,nl3_c,nu3_c,  & 
                              nseg_c,nvctr_c,keyg_c,keyv_c,  & 
                              nseg_f,nvctr_f,keyg_f,keyv_f,  & 
                              psi_c,psi_f,psig_stand1)

       call ConvolStand(nl1_c,nu1_c,nl2_c,nu2_c,nl3_c,nu3_c,nl1_f,nu1_f,nl2_f,nu2_f,nl3_f,nu3_f, & 
                        hgrid,psig_stand1,psig_stand2)
          
        call compress_forstandard(n1,n2,n3,nl1_c,nu1_c,nl2_c,nu2_c,nl3_c,nu3_c,  & 
                            nseg_c,nvctr_c,keyg_c,keyv_c,  & 
                            nseg_f,nvctr_f,keyg_f,keyv_f,  & 
         ...
         enddo
          ...
          DO J=1,NVCTR_F
            DO I=1,7
              tt=HPSI_F(i,j)+C*PSI_F(i,j)-GG_F(i,j)   
              HPSI_F(i,j)=tt
              HPSI2=HPSI2+tt**2  
            ENDDO
          ENDDO
        ...
        subroutine prec_diag(n1,n2,n3,hgrid,nseg_c,nvctr_c,nvctr_f,keyg_c,keyv_c,hpsi_c,hpsi_f,C)
! 
!
        implicit real*8 (a-h,o-z)
...
subroutine ConvolStand(nl1_c,nu1_c,nl2_c,nu2_c,nl3_c,nu3_c,nl1_f,nu1_f,nl2_f,nu2_f,nl3_f,nu3_f,hgrid,x,y)
