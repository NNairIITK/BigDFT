...
subroutine coupling_matrix_prelim(iproc,nproc,geocode,tddft_approach,nspin,lr,orbsocc,orbsvirt,i3s,n3p,&
  ...
  !logical :: tda=.true.
  logical :: dofH=.true.,dofxc=.true.,perx,pery,perz
...
!  call yaml_comment('ndipoles=',trim(yaml_toa(ndipoles,fmt='(i4.4)')))
  write(*,*) 'ndipoles=', ndipoles
