...
/* atoms_get_amu src/init/atoms.f90:1823 */
/* Fortran header:
...
/* atoms_get_aocc src/init/atoms.f90:1833 */
/* Fortran header:
...
/* atoms_get_iasctype src/init/atoms.f90:1751 */
/* Fortran header:
...
/* atoms_get_iatype src/init/atoms.f90:1743 */
/* Fortran header:
...
/* atoms_get_ifrztyp src/init/atoms.f90:1767 */
/* Fortran header:
...
/* atoms_get_ig_nlccpar src/init/atoms.f90:1874 */
/* Fortran header:
...
/* atoms_get_ixcpsp src/init/atoms.f90:1815 */
/* Fortran header:
...
/* atoms_get_natpol src/init/atoms.f90:1759 */
/* Fortran header:
...
/* atoms_get_nelpsp src/init/atoms.f90:1775 */
/* Fortran header:
...
/* atoms_get_nlcc_ngc src/init/atoms.f90:1807 */
/* Fortran header:
...
/* atoms_get_nlcc_ngv src/init/atoms.f90:1799 */
/* Fortran header:
...
/* atoms_get_nlccpar src/init/atoms.f90:1864 */
/* Fortran header:
...
/* atoms_get_npspcode src/init/atoms.f90:1783 */
/* Fortran header:
...
/* atoms_get_nzatom src/init/atoms.f90:1791 */
/* Fortran header:
...
/* atoms_get_psppar src/init/atoms.f90:1854 */
/* Fortran header:
...
/* atoms_get_radii_cf src/init/atoms.f90:1844 */
/* Fortran header:
...
/* localfields_get_rhov src/bindings/bindingsf.f90:907 */
/* Fortran header:
...
/* localfields_get_v_ext src/bindings/bindingsf.f90:915 */
/* Fortran header:
...
/* localfields_get_v_xc src/bindings/bindingsf.f90:923 */
/* Fortran header:
...
/* orbs_get_eval src/bindings/bindingsf.f90:695 */
/* Fortran header:
...
/* orbs_get_inwhichlocreg src/bindings/bindingsf.f90:727 */
/* Fortran header:
...
/* orbs_get_kpts src/bindings/bindingsf.f90:711 */
/* Fortran header:
...
/* orbs_get_kwgts src/bindings/bindingsf.f90:719 */
/* Fortran header:
...
/* orbs_get_occup src/bindings/bindingsf.f90:703 */
/* Fortran header:
...
/* orbs_get_onwhichatom src/bindings/bindingsf.f90:743 */
/* Fortran header:
...
/* orbs_get_onwhichmpi src/bindings/bindingsf.f90:735 */
/* Fortran header:
...
/* atoms_copy_alat src/init/atoms.f90:1936 */
/* Fortran header:
...
void FC_FUNC_(atoms_copy_alat, ATOMS_COPY_ALAT)(const _atoms_data *atoms, 
                                                ...
                                                double *alat2, 
                                                double *alat3);
/* atoms_copy_geometry_data src/init/atoms.f90:1884 */
/* Fortran header:
...
void FC_FUNC_(atoms_copy_geometry_data, ATOMS_COPY_GEOMETRY_DATA)(const _atoms_data *atoms, 
                                                                  ...
                                                                  int str_ln_2, 
                                                                  int str_ln_3);
/* atoms_copy_name src/init/atoms.f90:1910 */
/* Fortran header:
...
void FC_FUNC_(atoms_copy_name, ATOMS_COPY_NAME)(const _atoms_data *atoms, 
                                                ...
                                                int *ln, 
                                                int str_ln_1);
/* atoms_copy_nat src/init/atoms.f90:1727 */
/* Fortran header:
...
void FC_FUNC_(atoms_copy_nat, ATOMS_COPY_NAT)(const _atoms_data *atoms, 
                                              int *nat);
/* atoms_copy_ntypes src/init/atoms.f90:1735 */
/* Fortran header:
...
void FC_FUNC_(atoms_copy_ntypes, ATOMS_COPY_NTYPES)(const _atoms_data *atoms, 
                                                    int *ntypes);
/* atoms_copy_psp_data src/init/atoms.f90:1898 */
/* Fortran header:
...
void FC_FUNC_(atoms_copy_psp_data, ATOMS_COPY_PSP_DATA)(const _atoms_data *atoms, 
                                                        int *natsc, 
                                                        int *donlcc);
/* atoms_empty src/init/atoms.f90:1665 */
/* Fortran header:
...
/* atoms_get src/init/atoms.f90:1719 */
/* Fortran header:
...
void FC_FUNC_(atoms_new, ATOMS_NEW)(_atoms_data **atoms, 
                                    _symmetry_data **sym);
/* atoms_read_variables src/init/atoms.f90:1674 */
/* Fortran header:
...
/* atoms_set_from_file src/init/atoms.f90:1623 */
/* Fortran header:
...
void FC_FUNC_(atoms_set_from_file, ATOMS_SET_FROM_FILE)(int *lstat, 
                                                        ...
                                                        const int *ln, 
                                                        int str_ln_1);
/* atoms_set_name src/init/atoms.f90:1692 */
/* Fortran header:
...
/* atoms_sync src/init/atoms.f90:1701 */
/* Fortran header:
...
void FC_FUNC_(atoms_sync, ATOMS_SYNC)(_atoms_data *atoms, 
                                      ...
                                      int str_ln_2, 
                                      int str_ln_3);
/* atoms_write src/init/atoms.f90:1646 */
/* Fortran header:
...
void FC_FUNC_(atoms_write, ATOMS_WRITE)(const _atoms_data *atoms, 
                                        ...
                                        int str_ln_1, 
                                        int str_ln_2);
/* bigdft_finalize src/external.f90:87 */
/* Fortran header:
...
/* energs_copy_data src/bindings/bindingsf.f90:1173 */
/* Fortran header:
...
/* global_output_free src/bindings/bindingsf.f90:1144 */
/* Fortran header:
...
/* global_output_get src/bindings/bindingsf.f90:1152 */
/* Fortran header:
...
void FC_FUNC_(global_output_get, GLOBAL_OUTPUT_GET)(const _DFT_global_output *outs, 
                                                    ...
                                                    double *strten, 
                                                    double *etot);
/* global_output_new src/bindings/bindingsf.f90:1129 */
/* Fortran header:
...
/* gpu_free src/bindings/bindingsf.f90:971 */
/* Fortran header:
...
/* gpu_new src/bindings/bindingsf.f90:964 */
/* Fortran header:
...
/* inputs_check_psi_id src/bindings/bindingsf.f90:584 */
/* Fortran header:
...
/* inputs_get_dft src/bindings/bindingsf.f90:474 */
/* Fortran header:
...
void FC_FUNC_(inputs_get_dft, INPUTS_GET_DFT)(const _input_variables *in, 
                                              ...
                                              int *nplottedvirt, 
                                              int *sym);
/* inputs_get_files src/bindings/bindingsf.f90:567 */
/* Fortran header:
...
void FC_FUNC_(inputs_get_files, INPUTS_GET_FILES)(const _input_variables *in, 
                                                  int *files);
/* inputs_get_geopt src/bindings/bindingsf.f90:533 */
/* Fortran header:
...
void FC_FUNC_(inputs_get_geopt, INPUTS_GET_GEOPT)(const _input_variables *in, 
                                                  ...
                                                  int str_ln_1);
/* inputs_get_linear src/bindings/bindingsf.f90:575 */
/* Fortran header:
...
/* inputs_get_mix src/bindings/bindingsf.f90:514 */
/* Fortran header:
...
void FC_FUNC_(inputs_get_mix, INPUTS_GET_MIX)(const _input_variables *in, 
                                              ...
                                              double *Tel, 
                                              double *alphadiis);
/* inputs_get_perf src/bindings/bindingsf.f90:559 */
/* Fortran header:
...
void FC_FUNC_(inputs_parse_params, INPUTS_PARSE_PARAMS)(_input_variables *in, 
                                                        const int *iproc, 
                                                        const int *dump);
/* inputs_set_restart src/bindings/bindingsf.f90:595 */
/* Fortran header:
...
void FC_FUNC(ionicenergyandforces, IONICENERGYANDFORCES)(const int *iproc, 
                                                         ...
                                                         const _coulomb_operator *pkernel, 
                                                         double *psoffset);
/* kernel_get_comm src/bindings/bindingsf.f90:801 */
/* Fortran header:
...
void FC_FUNC_(kswfn_mpi_copy, KSWFN_MPI_COPY)(double *psic, 
                                              ...
                                              const int *psiStart, 
                                              const int *psiSize);
/* kswfn_optimization_loop src/cluster.f90:1332 */
/* Fortran header:
...
void FC_FUNC_(kswfn_optimization_loop, KSWFN_OPTIMIZATION_LOOP)(const int *iproc, 
                                                                ...
                                                                double *xcstr, 
                                                                const _input_variables *in);
/* kswfn_post_treatments src/cluster.f90:1716 */
/* Fortran header:
...
void FC_FUNC_(kswfn_post_treatments, KSWFN_POST_TREATMENTS)(const int *iproc, 
                                                            ...
                                                            int str_ln_1, 
                                                            int str_ln_2);
/* localfields_copy_metadata src/bindings/bindingsf.f90:894 */
/* Fortran header:
...
void FC_FUNC_(localfields_copy_metadata, LOCALFIELDS_COPY_METADATA)(const _DFT_local_fields *denspot, 
                                                                    ...
                                                                    int *ni, 
                                                                    double *psoffset);
/* localfields_free src/bindings/bindingsf.f90:836 */
/* Fortran header:
...
void FC_FUNC_(localfields_free, LOCALFIELDS_FREE)(_DFT_local_fields **denspotd, 
                                                  f90_pointer_double_2D *fion, 
                                                  f90_pointer_double_2D *fdisp);
/* localfields_get_data src/bindings/bindingsf.f90:826 */
/* Fortran header:
...
void FC_FUNC_(localfields_get_data, LOCALFIELDS_GET_DATA)(const _DFT_local_fields *denspotd, 
                                                          ...
                                                          _denspot_distribution **dpbox);
/* localfields_get_pkernel src/bindings/bindingsf.f90:931 */
/* Fortran header:
...
/* localfields_get_pkernelseq src/bindings/bindingsf.f90:939 */
/* Fortran header:
...
/* localfields_new src/bindings/bindingsf.f90:813 */
/* Fortran header:
...
void FC_FUNC(memoryestimator, MEMORYESTIMATOR)(const int *nproc, 
                                               ...
                                               const int *iscf, 
                                               double *peakmem);
/* optloop_bcast src/bindings/bindingsf.f90:1309 */
/* Fortran header:
...
void FC_FUNC_(optloop_bcast, OPTLOOP_BCAST)(_DFT_optimization_loop *optloop, 
                                            const int *iproc);
/* optloop_copy_data src/bindings/bindingsf.f90:1213 */
/* Fortran header:
...
void FC_FUNC_(optloop_copy_data, OPTLOOP_COPY_DATA)(const _DFT_optimization_loop *optloop, 
                                                    ...
                                                    int *iscf, 
                                                    int *infocode);
/* optloop_free src/bindings/bindingsf.f90:1206 */
/* Fortran header:
...
/* optloop_new src/bindings/bindingsf.f90:1197 */
/* Fortran header:
...
/* optloop_sync_data src/bindings/bindingsf.f90:1236 */
/* Fortran header:
...
void FC_FUNC_(optloop_sync_data, OPTLOOP_SYNC_DATA)(_DFT_optimization_loop *optloop, 
                                                    ...
                                                    const int *iscf, 
                                                    const int *infocode);
/* orbs_comm_empty src/bindings/bindingsf.f90:664 */
/* Fortran header:
...
/* orbs_comm_free src/bindings/bindingsf.f90:655 */
/* Fortran header:
...
/* orbs_comm_init src/bindings/bindingsf.f90:643 */
/* Fortran header:
...
void FC_FUNC_(orbs_comm_init, ORBS_COMM_INIT)(_communications_arrays *comms, 
                                              ...
                                              const int *iproc, 
                                              const int *nproc);
/* orbs_comm_new src/bindings/bindingsf.f90:633 */
/* Fortran header:
...
/* orbs_empty src/bindings/bindingsf.f90:626 */
/* Fortran header:
...
/* orbs_free src/bindings/bindingsf.f90:618 */
/* Fortran header:
...
/* orbs_get_dimensions src/bindings/bindingsf.f90:675 */
/* Fortran header:
...
void FC_FUNC_(orbs_get_dimensions, ORBS_GET_DIMENSIONS)(const _orbitals_data *orbs, 
                                                        ...
                                                        int *isorb, 
                                                        int *iskpts);
/* orbs_get_iorbp src/bindings/bindingsf.f90:1102 */
/* Fortran header:
...
void FC_FUNC_(orbs_get_iorbp, ORBS_GET_IORBP)(const _orbitals_data *orbs, 
                                              ...
                                              const int *ispin, 
                                              const int *ispinor);
/* orbs_init src/bindings/bindingsf.f90:611 */
/* Fortran header:
...
/* orbs_new src/bindings/bindingsf.f90:604 */
/* Fortran header:
...
/* orbs_open_file src/bindings/bindingsf.f90:751 */
/* Fortran header:
...
void FC_FUNC_(orbs_open_file, ORBS_OPEN_FILE)(const _orbitals_data *orbs, 
                                              ...
                                              const int *ispinor, 
                                              int str_ln_1);
/* proj_free src/bindings/bindingsf.f90:777 */
/* Fortran header:
...
void FC_FUNC_(proj_free, PROJ_FREE)(_nonlocal_psp_descriptors **nlpspd, 
                                    f90_pointer_double *proj);
/* proj_get_dimensions src/bindings/bindingsf.f90:791 */
/* Fortran header:
...
void FC_FUNC_(proj_get_dimensions, PROJ_GET_DIMENSIONS)(const _nonlocal_psp_descriptors *nlpspd, 
                                                        int *nproj, 
                                                        int *nprojel);
/* proj_new src/bindings/bindingsf.f90:770 */
/* Fortran header:
...
void FC_FUNC_(read_wave_to_isf, READ_WAVE_TO_ISF)(int *lstat, 
                                                  ...
                                                  int str_ln_1);
/* rst_free src/bindings/bindingsf.f90:1354 */
/* Fortran header:
...
/* rst_init src/bindings/bindingsf.f90:1362 */
/* Fortran header:
...
/* rst_new src/bindings/bindingsf.f90:1345 */
/* Fortran header:
...
/* run_objects_destroy src/bindings/bindingsf.f90:1381 */
/* Fortran header:
...
/* run_objects_get src/bindings/bindingsf.f90:1395 */
/* Fortran header:
...
void FC_FUNC_(run_objects_get, RUN_OBJECTS_GET)(const _run_objects *runObj, 
                                                ...
                                                _restart_objects **rst, 
                                                f90_pointer_double_2D *rxyz);
/* run_objects_new src/bindings/bindingsf.f90:1373 */
/* Fortran header:
...
/* run_objects_set src/cluster.f90:279 */
/* Fortran header:
...
*/
void FC_FUNC_(run_objects_set, RUN_OBJECTS_SET)(_run_objects *runObj, 
                                                const _input_variables *inputs, 
                                                const _atoms_data *atoms, 
...
void FC_FUNC_(run_objects_set_from_files, RUN_OBJECTS_SET_FROM_FILES)(_run_objects *runObj, 
                                                                      ...
                                                                      int str_ln_1, 
                                                                      int str_ln_2);
/* run_objects_set_rxyz src/bindings/bindingsf.f90:1409 */
/* Fortran header:
...
real(gp), dimension(:,:), pointer :: rxyz
*/
void FC_FUNC_(run_objects_set_rxyz, RUN_OBJECTS_SET_RXYZ)(_run_objects *runObj, 
                                                          f90_pointer_double_2D *rxyz);
...
void FC_FUNC_(standard_inputfile_names, STANDARD_INPUTFILE_NAMES)(_input_variables *in, 
                                                                  ...
                                                                  const int *nproc, 
                                                                  int str_ln_1);
/* symmetry_set_irreductible_zone src/init/atoms.f90:1947 */
/* Fortran header:
...
void FC_FUNC_(update_wavefunctions_size, UPDATE_WAVEFUNCTIONS_SIZE)(const _local_zone_descriptors *lzd, 
                                                                    ...
                                                                    const int *iproc, 
                                                                    const int *nproc);
/* wf_empty src/bindings/bindingsf.f90:1020 */
/* Fortran header:
...
/* wf_free src/bindings/bindingsf.f90:1044 */
/* Fortran header:
...
/* wf_get_data src/bindings/bindingsf.f90:1008 */
/* Fortran header:
...
void FC_FUNC_(wf_get_data, WF_GET_DATA)(const _DFT_wavefunction *wf, 
                                        ...
                                        _local_zone_descriptors **lzd);
/* wf_get_psi src/bindings/bindingsf.f90:1055 */
/* Fortran header:
...
void FC_FUNC_(wf_get_psi, WF_GET_PSI)(const _DFT_wavefunction *wf, 
                                      long *psi, 
                                      long *hpsi);
/* wf_get_psi_size src/bindings/bindingsf.f90:1071 */
/* Fortran header:
...
void FC_FUNC_(wf_get_psi_size, WF_GET_PSI_SIZE)(f90_pointer_double *psi, 
                                                long *psiSize);
/* wf_iorbp_to_psi src/bindings/bindingsf.f90:1079 */
/* Fortran header:
...
void FC_FUNC_(wf_iorbp_to_psi, WF_IORBP_TO_PSI)(double *psir, 
                                                const double *psi, 
                                                const _locreg_descriptors *lr);
/* wf_new src/bindings/bindingsf.f90:979 */
/* Fortran header:
...
void FC_FUNC_(wf_new, WF_NEW)(const long *self, 
                              ...
                              _communications_arrays **comm, 
                              _local_zone_descriptors **lzd);
/* write_extra_info src/init/atoms.f90:1412 */
/* Fortran header:
