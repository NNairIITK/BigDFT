...
/* atoms_get_amu src/init/atoms.f90:1857 */
/* Fortran header:
...
/* atoms_get_aocc src/init/atoms.f90:1867 */
/* Fortran header:
...
*/
void FC_FUNC_(atoms_get_aocc, ATOMS_GET_AOCC)(const f90_atoms_data *atoms, 
                                              f90_pointer_double_2D *aocc);
/* atoms_get_iasctype src/init/atoms.f90:1759 */
/* Fortran header:
...
*/
void FC_FUNC_(atoms_get_iasctype, ATOMS_GET_IASCTYPE)(const f90_atoms_data *atoms, 
                                                      f90_pointer_int *iasctype);
/* atoms_get_iatype src/init/atoms.f90:1749 */
/* Fortran header:
...
/* atoms_get_ifrztyp src/init/atoms.f90:1779 */
/* Fortran header:
...
/* atoms_get_ig_nlccpar src/init/atoms.f90:1908 */
/* Fortran header:
...
*/
void FC_FUNC_(atoms_get_ig_nlccpar, ATOMS_GET_IG_NLCCPAR)(const f90_atoms_data *atoms, 
                                                          f90_pointer_double_2D *ig_nlccpar);
/* atoms_get_ixcpsp src/init/atoms.f90:1847 */
/* Fortran header:
...
/* atoms_get_natpol src/init/atoms.f90:1769 */
/* Fortran header:
...
/* atoms_get_nelpsp src/init/atoms.f90:1799 */
/* Fortran header:
...
/* atoms_get_nlcc_ngc src/init/atoms.f90:1837 */
/* Fortran header:
...
/* atoms_get_nlcc_ngv src/init/atoms.f90:1829 */
/* Fortran header:
...
/* atoms_get_nlccpar src/init/atoms.f90:1898 */
/* Fortran header:
...
/* atoms_get_npspcode src/init/atoms.f90:1809 */
/* Fortran header:
...
/* atoms_get_nzatom src/init/atoms.f90:1819 */
/* Fortran header:
...
/* atoms_get_psppar src/init/atoms.f90:1888 */
/* Fortran header:
...
/* atoms_get_radii_cf src/init/atoms.f90:1878 */
/* Fortran header:
...
/* atoms_get_rxyz src/init/atoms.f90:1789 */
/* Fortran header:
...
/* orbs_get_onwhichmpi  */
/* allocate_atoms_nat src/init/atoms.f90:242 */
/* Fortran header:
...
void FC_FUNC_(astruct_copy_alat, ASTRUCT_COPY_ALAT)(const f90_atomic_structure *astruct, 
                                                    double *alat);
/* astruct_copy_geometry_data src/init/atoms.f90:1918 */
/* Fortran header:
...
void FC_FUNC_(astruct_copy_geometry_data, ASTRUCT_COPY_GEOMETRY_DATA)(const f90_atomic_structure *astruct, 
                                                                      ...
                                                                      int str_ln_2, 
                                                                      int str_ln_3);
/* astruct_copy_name src/init/atoms.f90:1944 */
/* Fortran header:
...
void FC_FUNC_(astruct_copy_name, ASTRUCT_COPY_NAME)(const f90_atomic_structure *astruct, 
                                                    ...
                                                    int *ln, 
                                                    int str_ln_1);
/* astruct_copy_nat src/init/atoms.f90:1729 */
/* Fortran header:
...
void FC_FUNC_(astruct_copy_nat, ASTRUCT_COPY_NAT)(const f90_atomic_structure *astruct, 
                                                  int *nat);
/* astruct_copy_ntypes src/init/atoms.f90:1739 */
/* Fortran header:
...
void FC_FUNC_(astruct_copy_ntypes, ASTRUCT_COPY_NTYPES)(const f90_atomic_structure *astruct, 
                                                        int *ntypes);
/* astruct_set_displacement src/init/atoms.f90:430 */
/* Fortran header:
...
/* astruct_set_from_file src/init/atoms.f90:1646 */
/* Fortran header:
...
void FC_FUNC_(astruct_set_from_file, ASTRUCT_SET_FROM_FILE)(int *lstat, 
                                                            ...
                                                            const char *filename, 
                                                            int str_ln_1);
/* astruct_set_geometry src/init/atoms.f90:1701 */
/* Fortran header:
...
void FC_FUNC_(astruct_set_n_atoms, ASTRUCT_SET_N_ATOMS)(f90_atomic_structure *astruct, 
                                                        ...
                                                        const char *subname, 
                                                        int str_ln_1);
/* astruct_set_n_types src/init/atoms.f90:332 */
/* Fortran header:
...
void FC_FUNC_(astruct_set_n_types, ASTRUCT_SET_N_TYPES)(f90_atomic_structure *astruct, 
                                                        ...
                                                        const char *subname, 
                                                        int str_ln_1);
/* astruct_set_symmetries src/init/atoms.f90:355 */
/* Fortran header:
...
void FC_FUNC_(astruct_set_symmetries, ASTRUCT_SET_SYMMETRIES)(f90_atomic_structure *astruct, 
                                                              ...
                                                              const int *nspin);
/* atoms_copy_alat  */
/* atoms_empty src/init/atoms.f90:1681 */
/* Fortran header:
...
/* atoms_free src/init/atoms.f90:25 */
/* Fortran header:
...
/* atoms_get src/init/atoms.f90:1717 */
/* Fortran header:
...
/* atoms_set_name src/init/atoms.f90:1690 */
/* Fortran header:
...
void FC_FUNC_(atoms_set_name, ATOMS_SET_NAME)(f90_atoms_data *atoms, 
                                              ...
                                              const char *name, 
                                              int str_ln_1);
/* atoms_write src/init/atoms.f90:1662 */
/* Fortran header:
...
void FC_FUNC_(bigdft_init_mpi_force, BIGDFT_INIT_MPI_FORCE)(const int *igroup, 
                                                            const int *ngroup);
/* bigdft_mpi_init  */
/* call_bigdft src/cluster.f90.~1~:12 src/cluster.f90:12 */
/* Fortran header:
...
/* create_dir_output src/input_variables.f90:409 */
/* Fortran header:
...
void FC_FUNC_(denspot_full_v_ext, DENSPOT_FULL_V_EXT)(const f90_DFT_local_fields *denspot, 
                                                      ...
                                                      const int *iproc, 
                                                      int *new);
/* dict_append src/bindings/bindingsf.f90:1611 */
/* Fortran header:
...
/* dict_dump src/bindings/bindingsf.f90:1627 */
/* Fortran header:
...
void FC_FUNC_(dict_insert, DICT_INSERT)(f90_dictionary_pointer *dict, 
                                        ...
                                        int str_ln_1);
/* dict_new  */
/* dict_parse src/bindings/bindingsf.f90:1635 */
/* Fortran header:
...
void FC_FUNC_(dict_parse, DICT_PARSE)(f90_dictionary_pointer *dict, 
                                      const char *buf, 
                                      int str_ln_1);
/* dict_put src/bindings/bindingsf.f90:1618 */
/* Fortran header:
...
/* energs_copy_data src/bindings/bindingsf.f90:1259 */
/* Fortran header:
...
/* global_output_free src/bindings/bindingsf.f90:1230 */
/* Fortran header:
...
/* global_output_get src/bindings/bindingsf.f90:1238 */
/* Fortran header:
...
*/
void FC_FUNC_(image_new, IMAGE_NEW)(f90_run_image_pointer *img, 
                                    f90_run_objects_pointer *run, 
                                    f90_DFT_global_output_pointer *outs, 
                                    const f90_atoms_data *atoms, 
                                    const f90_input_variables *inputs, 
                                    const f90_restart_objects *rst, 
                                    const int *algorithm);
...
*/
void FC_FUNC_(inputs_get_files, INPUTS_GET_FILES)(const f90_input_variables *in, 
                                                  int *files);
...
*/
void FC_FUNC_(inputs_get_naming, INPUTS_GET_NAMING)(const f90_input_variables *in, 
                                                    char *run_name, 
                                                    char *file_occnum, 
                                                    char *file_igpop, 
                                                    char *file_lin, 
...
type(input_variables), pointer :: in
*/
void FC_FUNC_(inputs_new, INPUTS_NEW)(f90_input_variables_pointer *in);
...
*/
void FC_FUNC_(inputs_set_from_file, INPUTS_SET_FROM_FILE)(f90_dictionary_pointer *dict, 
                                                          const char *fname, 
                                                          int str_ln_1);
...
integer, intent(in) :: id
*/
void FC_FUNC_(inputs_set_restart, INPUTS_SET_RESTART)(f90_input_variables *in, 
                                                      const int *id);
/* input_wf src/init.f90:1511 */
/* Fortran header:
...
void FC_FUNC_(kswfn_mpi_copy, KSWFN_MPI_COPY)(double *psic, 
                                              ...
                                              const int *psiStart, 
                                              const int *psiSize);
/* kswfn_optimization_loop src/cluster.f90.~1~:1416 src/cluster.f90:1415 */
/* Fortran header:
...
void FC_FUNC_(kswfn_optimization_loop, KSWFN_OPTIMIZATION_LOOP)(const int *iproc, 
                                                                ...
                                                                double *xcstr, 
                                                                const f90_input_variables *in);
/* kswfn_post_treatments src/cluster.f90.~1~:1802 src/cluster.f90:1801 */
/* Fortran header:
...
void FC_FUNC_(lzd_set_nlr, LZD_SET_NLR)(f90_local_zone_descriptors *lzd, 
                                        ...
                                        const char *geocode, 
                                        int str_ln_1);
/* mem_destroy src/bindings/bindingsf.f90:1568 */
/* Fortran header:
...
/* mem_new src/bindings/bindingsf.f90:1561 */
/* Fortran header:
...
/* mem_to_c src/bindings/bindingsf.f90:1576 */
/* Fortran header:
...
/* optloop_bcast src/bindings/bindingsf.f90:1395 */
/* Fortran header:
...
void FC_FUNC_(optloop_bcast, OPTLOOP_BCAST)(f90_DFT_optimization_loop *optloop, 
                                            const int *iproc);
/* optloop_copy_data src/bindings/bindingsf.f90:1299 */
/* Fortran header:
...
void FC_FUNC_(optloop_copy_data, OPTLOOP_COPY_DATA)(const f90_DFT_optimization_loop *optloop, 
                                                    ...
                                                    int *iscf, 
                                                    int *infocode);
/* optloop_free src/bindings/bindingsf.f90:1292 */
/* Fortran header:
...
/* optloop_new src/bindings/bindingsf.f90:1283 */
/* Fortran header:
...
/* optloop_sync_data src/bindings/bindingsf.f90:1322 */
/* Fortran header:
...
void FC_FUNC_(read_wave_to_isf, READ_WAVE_TO_ISF)(int *lstat, 
                                                  ...
                                                  int str_ln_1);
/* rst_free src/bindings/bindingsf.f90:1440 */
/* Fortran header:
...
*/
void FC_FUNC_(rst_free, RST_FREE)(f90_restart_objects_pointer *rst);
/* rst_init src/bindings/bindingsf.f90:1448 */
/* Fortran header:
...
type(input_variables), intent(in) :: inputs
*/
void FC_FUNC_(rst_init, RST_INIT)(f90_restart_objects *rst, 
                                  const int *iproc, 
                                  const f90_atoms_data *atoms, 
                                  const f90_input_variables *inputs);
/* rst_new src/bindings/bindingsf.f90:1431 */
/* Fortran header:
...
/* run_objects_destroy src/bindings/bindingsf.f90:1470 */
/* Fortran header:
...
/* run_objects_dump_to_file src/bindings/bindingsf.f90:1506 */
/* Fortran header:
...
void FC_FUNC_(run_objects_dump_to_file, RUN_OBJECTS_DUMP_TO_FILE)(int *iostat, 
                                                                  ...
                                                                  const int *userOnly, 
                                                                  int str_ln_1);
/* run_objects_get src/bindings/bindingsf.f90:1483 */
/* Fortran header:
...
void FC_FUNC_(run_objects_init_from_files, RUN_OBJECTS_INIT_FROM_FILES)(f90_run_objects *runObj, 
                                                                        ...
                                                                        int str_ln_1, 
                                                                        int str_ln_2);
/* run_objects_new src/bindings/bindingsf.f90:1459 */
/* Fortran header:
...
/* run_objects_nullify_dict src/bindings/bindingsf.f90:1553 */
/* Fortran header:
...
*/
void FC_FUNC_(standard_inputfile_names, STANDARD_INPUTFILE_NAMES)(f90_input_variables *in, 
                                                                  const char *radical, 
                                                                  int str_ln_1);
/* symmetry_set_irreductible_zone src/init/atoms.f90:1983 */
/* Fortran header:
...
*/
void FC_FUNC_(symmetry_set_irreductible_zone, SYMMETRY_SET_IRREDUCTIBLE_ZONE)(f90_symmetry_data *sym, 
                                                                              const char *geocode, 
                                                                              const int *n1i, 
                                                                              const int *n2i, 
                                                                              const int *n3i, 
...
void FC_FUNC_(wf_new, WF_NEW)(const long *self, 
                              ...
                              f90_communications_arrays_pointer *comm, 
                              f90_local_zone_descriptors_pointer *lzd);
/* write_extra_info src/init/atoms.f90:1399 */
/* Fortran header:
