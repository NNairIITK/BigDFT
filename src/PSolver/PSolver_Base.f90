...
!!$  if (mod(n3,2).ne.0) stop 'Parallel convolution:ERROR:n3' !this can be avoided
  ...
  call ctrig_(n3,btrig3,after3,before3,now3,1,ic3)
  call ctrig_(n1,btrig1,after1,before1,now1,1,ic1)
  call ctrig_(n2,btrig2,after2,before2,now2,1,ic2)
  do  j=1,n1
  ...
  do j2=1,md2/nproc
     ...
     if (iproc*(md2/nproc)+j2.le.n2) then
        do i1=1,n1,lot
           ...
           inzee=1
           do i=1,ic3
              call fftstp_(lot,nfft,n3,lot,n3,zw(1,1,inzee),zw(1,1,3-inzee), &
...
!!$           call P_multkernel_old(n1,n2,n3,lot,nfft,j,i3,zw(1,1,inzee),hx,hy,hz,offset)!,fourisf)
        ...
        do j=1,n2,lot
           ...
           !performing FFT
           i=1
           call fftstp_(lzt,nfft,n1,lot,n1,zt(1,j,1),zw(1,1,1), &
...
subroutine S_PoissonSolver(n1,n2,n3,nd1,nd2,nd3,md1,md2,md3,nproc,iproc,pot,zf&
  ...
  !calculating the FFT work arrays (beware on the HalFFT in n3 dimension)
  call ctrig_(n3/2,btrig3,after3,before3,now3,1,ic3)
  call ctrig_(n1,btrig1,after1,before1,now1,1,ic1)
  call ctrig_(n2,btrig2,after2,before2,now2,1,ic2)
  do  j=1,n1
     ftrig1(1,j)= btrig1(1,j)
