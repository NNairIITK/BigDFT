...
! The factor 6 is only allowed in the first place!
  data ((idata(i,j),i=1,7),j=1,149) /&
       ...
       54, 6, 3, 3, 1, 1, 1,     60, 5, 4, 3, 1, 1, 1,     64, 8, 8, 1, 1, 1, 1,     72, 8, 3, 3, 1, 1, 1,   &
      ...
      125, 5, 5, 5, 1, 1, 1,    128, 8, 4, 4, 1, 1, 1,    135, 5, 3, 3, 3, 1, 1,    144, 6, 8, 3, 1, 1, 1,   &
      150, 6, 5, 5, 1, 1, 1,    160, 8, 5, 4, 1, 1, 1,    162, 6, 3, 3, 3, 1, 1,    180, 5, 4, 3, 3, 1, 1,   &
      192, 6, 8, 4, 1, 1, 1,    200, 8, 5, 5, 1, 1, 1,    216, 8, 3, 3, 3, 1, 1,    225, 5, 5, 3, 3, 1, 1,   &
      240, 6, 8, 5, 1, 1, 1,    243, 3, 3, 3, 3, 3, 1,    256, 8, 8, 4, 1, 1, 1,    270, 6, 5, 3, 3, 1, 1,   &
      ...
      486, 6, 3, 3, 3, 3, 1,    500, 5, 5, 5, 4, 1, 1,    512, 8, 8, 8, 1, 1, 1,    540, 5, 4, 3, 3, 3, 1,   &
     ...
     1000, 8, 5, 5, 5, 1, 1,   1024, 4, 4, 4, 4, 4, 1,   1080, 6, 5, 4, 3, 3, 1,   1125, 5, 5, 5, 3, 3, 1,   &
     1152, 6, 4, 4, 4, 3, 1,   1200, 6, 8, 5, 5, 1, 1,   1215, 5, 3, 3, 3, 3, 3,   1280, 8, 8, 5, 4, 1, 1,   &
     ...
     7200, 6, 5, 5, 4, 4, 3,   7500, 5, 5, 5, 5, 4, 3,   7680, 6, 8, 8, 5, 4, 1,   8000, 8, 8, 5, 5, 5, 1,   &
     8192, 8, 8, 8, 4, 4, 1 /
  ...
  write(6,"(15(i5))") (idata(1,i),i=1,149)
  stop
1000 continue
