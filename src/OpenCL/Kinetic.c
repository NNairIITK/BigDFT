...
void FC_FUNC_(kinetic1d_d,KINETIC1D_D)(cl_command_queue *command_queue, cl_uint *n, cl_uint *ndat, double *h, double*c, cl_mem *x, cl_mem *y, cl_mem *workx, cl_mem *worky,double *ekin){
    ...
    cl_uint i = 0;
    clSetKernelArg(c_initialize_kernel_d, i++,sizeof(*n), (void*)n);
    clSetKernelArg(c_initialize_kernel_d, i++,sizeof(*ndat), (void*)ndat);
    ...
    ciErrNum = clEnqueueNDRangeKernel  (*command_queue, c_initialize_kernel_d, 2, NULL, globalWorkSize, localWorkSize, 0, NULL, NULL);
    ...
    clSetKernelArg(kinetic1d_kernel_d, i++,sizeof(double)*block_size_j*(block_size_i+FILTER_WIDTH), NULL);
    ciErrNum = clEnqueueNDRangeKernel  (*command_queue, kinetic1d_kernel_d, 2, NULL, globalWorkSize, localWorkSize, 0, NULL, NULL);
    if (ciErrNum != CL_SUCCESS)
    {
