...
subroutine calcforce_mix(posa,forca,energy,evalf_numbera, conva) !be careful, the energy is bogus
   ...
   use bigdft_forces
   implicit none
   real(8), intent(in), dimension(3*natoms) :: posa
   ...
   real(8), dimension(3*natoms)  :: force_class
   real(8), dimension(:),allocatable :: force_quant
   

   real(8), dimension(:), allocatable ::  posquant
   real(8), dimension(3*natoms)         :: pos_temp
   integer :: nat
