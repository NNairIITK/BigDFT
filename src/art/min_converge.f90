...
MODULE minimization_sd
  ...
  real(8), parameter :: FTHRESHOLD = 3.5D-1
  real(8), parameter :: STEPSIZE = 1.0D-4  ! Size in angstroems
...
subroutine min_converge_sd(minimized)
  ...
  real(8),  dimension(VECSIZE):: forceb, posb, tmp_pos
  integer :: iter, i, npart,ierror  
  real(8) :: current_ftot2, ftot,ftot2, step,  delr,le_total,current_energy
  logical :: conv
...
subroutine min_converge_fire(success)
  ...
  logical :: conv,success

!Fire parameters:
  real(8):: alpha,P,finc,fdec,falpha,alphastart,dt,dtmax,dtmd,fnrmtol,vnrm
  ...
  real(8),parameter :: norm_criterium = 0.008d0
  real(8),parameter :: fmax_criterium = 0.020d0
  integer :: miter
