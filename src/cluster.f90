     ...
     subd_loop : do icycle=1,in%nrepmax
        ...
        wfn_loop: do iter=1,in%itermax
           ...
           if (scpot) then
              ...
              !write(*,'(A,1X,I2,1X)',advance='no') 'iter:',iter
              call sumrho(iproc,nproc,orbs,&
                   Glr,ixc,hxh,hyh,hzh,psi,rhopot,&                             ! modified by Huan
...
!!!        call gaussian_orthogonality(iproc,nproc,norb,norbp,gbd,gaucoeffs)
  ...
  if (inputpsi /= -1000) then
     ...
     call sumrho(iproc,nproc,orbs,&
          Glr,0,hxh,hyh,hzh,psi,rho,n1i*n2i*n3p,&
