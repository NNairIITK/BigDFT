...
!!giu  call f_strcpy(src=denspot%pkernel%method,dest=comment)
!!giu  call f_strcpy(src='VAC',dest=denspot%pkernel%method)
...
!!giu  call f_strcpy(dest=denspot%pkernel%method,src=comment)
