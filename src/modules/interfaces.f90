...
module int_types
  ...
  implicit none
  private
  public :: wp,orbitals_data,wavefunctions_descriptors,gp,atoms_data
  public :: orbitals_data,locreg_descriptors,Dft_psp_projectors
  public :: DFT_local_fields,grid_dimensions,local_zone_descriptors
  public :: denspot_distribution,input_variables,coulomb_operator,dp
  public :: comms_cubic,f_enumerator,GPU_pointers,energy_terms,gaussian_basis
  public :: cdft_data,DFT_wavefunction,system_fragment
  public :: orthon_data,paw_objects,rho_descriptors,symmetry_data,xc_info
  public :: SIC_data,p2pComms,confpot_data,work_mpiaccumulate
  public :: workarrays_quartic_convolutions,workarr_precond,gaussian_basis_c
  public :: workarr_locham,localizedDIISParameters,work_transpose
  public :: fragmentInputParameters,DIIS_obj,atomic_structure
  public :: foe_data,comms_linear,sparse_matrix,matrices
  public :: fragment_transformation,phi_array
end module int_types
...
!!$       use module_types
  ...
  interface
     subroutine apply_potential(n1,n2,n3,nl1,nl2,nl3,nbuf,nspinor,npot,psir,pot,epot,&
          &   ibyyzz_r) !optional
       use int_types!         use module_defs, only: gp,dp,wp
       implicit none
