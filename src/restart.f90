subroutine reformatmywaves(iproc, norb, norbp, nat, &
  ...
  dimension :: psi_old(nvctr_c_old + 7 * nvctr_f_old, norbp), &
  ...
  if (hgrid_old.eq. hgrid .and. nvctr_c_old.eq.wfd%nvctr_c .and. nvctr_f_old.eq.wfd%nvctr_f  & 
     ...
     if (iproc==0) then
        ...
        else if (nvctr_c_old.ne.wfd%nvctr_c) then
           write(*,"(4x,a,2i8)") &
                'nvctr_c_old >< nvctr_c',nvctr_c_old,wfd%nvctr_c
        else if (nvctr_f_old.ne.wfd%nvctr_f)  then
           write(*,"(4x,a,2i8)") &
                'nvctr_f_old >< nvctr_f',nvctr_f_old,wfd%nvctr_f
