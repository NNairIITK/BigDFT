...
call setCommsOrtho(iproc, nproc, lzd%orbs, onWhichAtomAll, lzd, op, comon)
...
! Local variables
integer:: jproc, iorb, jorb, iiorb, jjorb, mpisource, mpidest, istsource, istdest, ncount, tag, istat, iall, ijorb
