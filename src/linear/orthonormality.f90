...
subroutine overlapPowerGeneral(iproc, nproc, iorder, ncalc, power, blocksize, imode, &
  ...
  integer :: nout, nseq, ispin, ishift, ishift2, isshift, ilshift, ilshift2, nspin, iline, icolumn
      ...
      if (iorder==0) then
          ...
          do ispin=1,nspin
              ...
              call transform_sparsity_pattern(inv_ovrlp_smat%nfvctr, &
                   ...
                   'small_to_large', Amat12_compr(ishift2+inv_ovrlp_smat%smmm%isvctr_mm+1:), &
                   Amat12p_new)
              call timing(iproc,'lovrlp^-1     ','ON')
