...
subroutine purify_kernel(iproc, nproc, tmb, overlap_calculated, it_shift, it_opt, order_taylor)
  ...
  if (it_shift>1) then
      ...
      !!        write(200+iproc,*) iorb, jorb, kernel_prime(jorb,iorb)
      !!    end do
      !!end do
      ...
      !!do iorb=1,tmb%orbs%norb
      !!    do jorb=1,tmb%orbs%norb
      !!        write(300+iproc,*) iorb, jorb, kernel_prime(jorb,iorb)
      !!    end do
      !!end do
  end if
  ...
  if (iproc==0) call yaml_open_sequence('purification process')
      ...
      if (shift/=0.d0) then
          ...
          !!do iorb=1,tmb%orbs%norb
          !!    do jorb=1,tmb%orbs%norb
          !!        write(400+iproc,*) iorb, jorb, tmb%linmat%denskern_large%matrix,(jorb,iorb)
          !!    end do
          !!end do
          ...
          !!do iorb=1,tmb%orbs%norb
          !!    do jorb=1,tmb%orbs%norb
          !!        write(500+iproc,*) iorb, jorb, tmb%linmat%denskern_large%matrix,(jorb,iorb)
          !!    end do
          !!end do
      end if
