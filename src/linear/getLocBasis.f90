...
real(kind=8),dimension(:,:),allocatable :: ovrlp!,test!,ovrlp_cpy
...
! Local variables
real(kind=8) :: trHold, fnrmMax, meanAlpha, gnrm_in, gnrm_out, ediff, noise
...
real(kind=8),dimension(:),pointer :: lhphi, lhphiold, lphiold
