...
!!!        charge=real(at%nelpsp(ityp),kind=8)/(2.d0*pi*sqrt(2.d0*pi)*rloc**3)
        ...
        rlocinv2sq=0.5_gp/rloc**2
        charge=real(at%nelpsp(atit%ityp),kind=8)/(2.d0*pi*sqrt(2.d0*pi)*rloc**3)
...
!!!        end do
        ...
        boxit = dpbox_iter(geocode,dpbox,nbox)
