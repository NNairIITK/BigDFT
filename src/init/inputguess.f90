...
subroutine     find_Scoeffs( Norder, Scoeffs, ng ,gcoeffs, expo, noccmax , lmax ,  psi,iocc_for_j, abs_final_L, psi1s, R , ene_for_j)
  use module_base
  implicit none
...
real*8 function phase( E, N, rgrid, V, nonloc, y,l,normalize,Z, onlyout)
  ...
  do i=2,ii
     ...
     if( (i+1) .le.ii ) then !  // LA PHASE EST CALCULE EN I
        ...
        if(yflag .and. (y(i)*y(i+1)).eq.0)then
           yflag=1-yflag
           yNcross=yNcross+1
        endif
     endif
...
subroutine schro(E, r,  V,nonloc, y, NGRID, nsol, l,  Z)
  ...
  pathh = Phase(Ehigh,NGRID,r,v,nonloc,y,  l ,0, Z);
  pathl = Phase(Elow ,NGRID, r,v,nonloc,y,  l ,0,  Z);
  ...
  if( pathl.gt.0.0)  then
   ...
   if(but .gt. pathh) then
      ...
      do while( but .gt. Phase(Ehigh ,NGRID, r,V,nonloc,y,  l , 0, Z )	 )
         Ehigh =2*Ehigh;
      enddo
   endif
   ...
   do while(1.gt.0) 
      ...
      fase=  Phase(Eguess ,NGRID, r,V,nonloc,y,  l , 0, Z )
   ...
   fase  = Phase(Eguess,NGRID, r,v,nonloc,y, l,1 ,  Z  )
   E=Eguess;
   print *, E, fase
...
! End of the big loop
  ...
  do isol=1,nsol
     ...
     call schro(Egrid(isol) , rgrid ,  potgrid , dumgrid1, psigrid_naked(:,isol) , ngrid , isol , labs ,  zion)
