subroutine ana_rot_per_old(right,nt,c,cd_1)
  ...
  integer :: i_all,i_stat,lenc,len_2,mod_left,mod_right,i,it,i2,it0,j,ji2,il2,ithread
...
subroutine syn_rot_per_old(right1,nt,cd,c1)
  ...
  integer :: i_all,i_stat,lenc,len_2,mod_left,mod_right,i,it,it0,i2,i_j,j,ji2,il2,i21,i_j2,j2,j21,ithread
