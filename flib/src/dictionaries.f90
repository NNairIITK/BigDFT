...
!   end interface operator(.poplast.)
   ...
   !> Private routines (to be removed from the doc generated by doxygen)
   private :: get_c1vec, get_ilvec, get_ivec, get_long, get_lvec, get_real, get_rvec
   private :: put_double, put_lg, put_long, put_real
   private :: remove_dict
