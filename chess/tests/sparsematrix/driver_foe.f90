...
!!!  call read_sparse_matrix('kernel_sparse.bin', nspin_l, geocode_l, cell_dim, nfvctr_l, nseg_l, nvctr_l, keyv_l, keyg_l, &
...
!!!       nspin=nspin_l, geocode=geocode_l, cell_dim=cell_dim, on_which_atom=on_which_atom_l)
